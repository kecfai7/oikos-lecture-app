...
- [Slide 11: PART 2: UNDER THE HOOD OF THE ASYNCHRONOUS ENGINE](#slide-11-part-2-under-the-hood-of-the-asynchronous-engine)
- [Slide 12: GEMINI 3.6 FLASH: THE MICRO-REASONING ENGINE](#slide-12-gemini-3-6-flash-the-micro-reasoning-engine)
- [Slide 13: TPU V8: THE GREEN SUSTAINABLE MUSCLE](#slide-13-tpu-v8-the-green-sustainable-muscle)
- [Slide 14: SPARK OS: ESTABLISHING THE AGENT'S DESK](#slide-14-spark-os-establishing-the-agent-s-desk)
- [Slide 15: OVERCOMING AMNESIA: DUAL-MEMORY ENGINE](#slide-15-overcoming-amnesia-dual-memory-engine)
- [Slide 16: OPERATIONAL PREREQUISITES CHECKLIST](#slide-16-operational-prerequisites-checklist)
- [Slide 17: THE TRIAD OF AGENTIC DESIGN](#slide-17-the-triad-of-agentic-design)
- [Slide 18: PILLAR 1: THE TASK FRAMEWORK](#slide-18-pillar-1-the-task-framework)
- [Slide 19: PILLAR 2: THE SCHEDULE TRIGGER](#slide-19-pillar-2-the-schedule-trigger)
- [Slide 20: PILLAR 3: THE SKILL INJECTION](#slide-20-pillar-3-the-skill-injection)
- [Slide 21: PART 3: THE CONNECTED WORKSPACE: NATIVE CROSS-APP WORKFLOWS](#slide-21-part-3-the-connected-workspace-native-cross-app-workflows)
- [Slide 22: NATIVE CROSS-APP PIPELINES](#slide-22-native-cross-app-pipelines)
- [Slide 23: GMAIL PARSING AND CONTEXT EXTRACTION](#slide-23-gmail-parsing-and-context-extraction)
- [Slide 24: DOCUMENT SYNTHESIS: AUTO-DOCS ENGINE](#slide-24-document-synthesis-auto-docs-engine)
- [Slide 25: CALENDAR MAPPING & COGNITIVE DEFENSE](#slide-25-calendar-mapping-cognitive-defense)
- [Slide 26: CHROME AUTO-BROWSING: BEYOND THE GOOGLE GARDEN](#slide-26-chrome-auto-browsing-beyond-the-google-garden)
- [Slide 27: CASE STUDY: THE VIRGIN VOYAGES MIRACLE](#slide-27-case-study-the-virgin-voyages-miracle)
- [Slide 28: REAL-WORLD SCENARIO 1: SMART TRAVEL ASSISTANT](#slide-28-real-world-scenario-1-smart-travel-assistant)
- [Slide 29: REAL-WORLD SCENARIO 2: GHOSTWRITER EMAIL AUTOMATION](#slide-29-real-world-scenario-2-ghostwriter-email-automation)
- [Slide 30: REAL-WORLD SCENARIO 3: WEEKLY STRATEGIC REVIEW](#slide-30-real-world-scenario-3-weekly-strategic-review)
- [Slide 31: PART 4: SECURING THE DIGITAL VAULT: GOVERNANCE & SAFETY](#slide-31-part-4-securing-the-digital-vault-governance-safety)
- [Slide 32: THE RISK OF THE UNCONTROLLED WALLET](#slide-32-the-risk-of-the-uncontrolled-wallet)
- [Slide 33: AP2: AGENT PAYMENTS PROTOCOL](#slide-33-ap2-agent-payments-protocol)
- [Slide 34: DESIGNING THE DIGITAL MANDATE](#slide-34-designing-the-digital-mandate)
- [Slide 35: HUMAN NOT PRESENT (HNP) TRANSACTIONS](#slide-35-human-not-present-hnp-transactions)
- [Slide 36: THE THREAT OF PROMPT INJECTION](#slide-36-the-threat-of-prompt-injection)
- [Slide 37: MITIGATING THE RISKS: SAFE PURGE PROTOCOLS](#slide-37-mitigating-the-risks-safe-purge-protocols)
- [Slide 38: THE SOVEREIGN CONDUCTOR: HUMAN-ON-THE-LOOP (HOTL)](#slide-38-the-sovereign-conductor-human-on-the-loop-hotl)
- [Slide 39: SOLI DEO GLORIA: REDEEMING THE TIME](#slide-39-soli-deo-gloria-redeeming-the-time)
- [Slide 40: LAB 2 ASSIGNMENT: ARCHITECTING YOUR SPARK OS BLUEPRINT](#slide-40-lab-2-assignment-architecting-your-spark-os-blueprint)
...
Welcome back, everyone! My name is Professor Peter Kim, and it is a true joy to welcome you back to Oikos University. Today, we open Session 2 of our master course: "The Architect of Intelligence."
...
- **강의 요약:** Session 2 강의 개요 및 Gemini Spark 자율 에이전트 아키텍처 환영 인사
- **핵심 포인트:**
...
- **강의 전달 팁:** 밝고 친절한 어조로 시작하세요. 해외 수강생들을 안심시키며 1분 30초 동안 여유롭게 전달합니다.

### 📚 Key Terms (주요 용어)
- **Gemini Spark**: A persistent cloud-resident agent framework powered by Google Cloud. (제미나이 스파크 (클라우드 지속형 에이전트 프레임워크))
- **Asynchronous Execution**: Non-blocking execution decoupled from local hardware status. (비동기 클라우드 실행)
...
We begin Part 1 of Session 2: "The 24/7 Sleep-Free Guardian Paradigm."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 1 섹션 전환: 24/7 수면 없는 수호자 패러다임
- **핵심 포인트:**
  - 에베소서 5:16 세월을 아끼라: 기계적 행정 노역에서 벗어나 거룩한 시간을 구속하는 신앙적 사명
  - 24시간 잠들지 않고 내 이메일과 일정을 지켜주는 Gemini Spark 클라우드 가디언 아키텍처의 도입
- **강의 전달 팁:** 잠자는 동안에도 나를 대신해 빈틈없이 시스템을 지켜주는 든든한 AI 수호자의 개념을 선포하세요.

### 📚 Key Terms (주요 용어)
- **Sleep-Free Guardian**: An autonomous, continuously running AI agent monitoring enterprise events and executing workflows 24/7. (잠들지 않는 수호자 (24/7 자율 에이전트))
...
Now, look at Slide 3. Here we see a very important problem: "The Active Tab Trap."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기존 챗봇의 브라우저 탭 종속 문제와 클라우드 에이전트의 지속성 비교
- **핵심 포인트:**
...
- **강의 전달 팁:** 노트북 뚜껑을 닫는 손동작을 취하며 'True digital freedom'을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Active Tab Trap**: The limitation where AI execution stops when a browser tab is closed. (활성 탭의 함정 (수동형 챗봇의 제약))
- **Cloud Persistence**: Continuous autonomous execution on remote cloud servers. (클라우드 지속성)
...
Let us move to Slide 4 and define "Persistent Cloud Autonomy" with three simple building blocks.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 지속적 클라우드 자율성(Persistent Cloud Autonomy)의 3대 구성 요소
- **핵심 포인트:**
  - 클라우드 상주성: 365일 24시간 멈추지 않는 구글 클라우드 인프라 활용
  - 하드웨어 독립성: 개인 PC 배터리나 인터넷 끊김에 영향을 받지 않음
  - 자율 위임: 단순 입력을 넘어 다단계 업무를 스스로 완수함
- **강의 전달 팁:** 3가지 카드를 하나씩 짚어주며 안정성과 자율성을 쉬운 단어로 설명합니다.

### 📚 Key Terms (주요 용어)
- **Hardware Independence**: Execution decoupling where cloud agents run regardless of client PC status. (하드웨어 독립성)
...
Slide 5 introduces an essential computer science term: "Asynchronous Execution." Sometimes this word sounds difficult, so let me explain it with a simple daily life story.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 동기식(Synchronous) 대 비동기식(Asynchronous) 처리 구조 비교
- **핵심 포인트:**
  - 식당 진동벨 비유를 통한 쉬운 개념 설명
  - Left: 카운터 앞에서 무작정 기다리는 동기식 처리
  - Right: 주문 후 편하게 앉아 있다가 알림을 받는 비동기식(Trigger-Execute-Notify) 처리
- **강의 전달 팁:** 식당 진동벨(Buzzer) 예시를 손동작과 함께 재미있게 풀어주세요.

### 📚 Key Terms (주요 용어)
- **Non-Blocking**: A software design pattern where execution does not lock user interface or thread. (논블로킹 (비동기 제어 구조))
...
Look at Slide 6: "The Offline Leveling Analogy."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 게임을 통한 비유: 수동 반복 작업(Grinding) 대 오프라인 자동 육성(Offline Leveling)
- **핵심 포인트:**
  - Left: 밤새 수작업으로 단순 노동을 반복하는 기존 업무 방식
  - Right: 사용자가 잠든 동안 클라우드에서 데이터 가공 및 리포트 생성을 수행하는 에이전트
  - 수강생 공감대 형성: 수면 시간 동안에도 축적되는 디지털 생산성
- **강의 전달 팁:** 친근한 오프라인 레벨업 비유로 미소를 띠며 설명하세요.

### 📚 Key Terms (주요 용어)
- **Offline Leveling**: Autonomous background progression that occurs while the user is offline. (오프라인 레벨업 (클라우드 자율 업무 처리))
...
Let us understand Spark's true identity on Slide 7.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Gemini Spark의 정체성: 사용자 의도를 대행하는 디지털 트윈(Digital Twin)
- **핵심 포인트:**
...
- **강의 전달 팁:** 스파크가 단순 AI가 아닌 '나의 믿음직한 대리인'임을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Digital Twin**: A personalized virtual proxy acting according to user rules and intent. (디지털 트윈 (개인화 가상 분신))
...
Let us pause for a moment and have an interactive poll on Slide 8!
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실시간 청중 설문조사: 24시간 에이전트에 가장 먼저 위임하고 싶은 업무
- **핵심 포인트:**
  - Option A: 이메일 파싱 및 CRM 자동 기록
  - Option B: 경쟁사 가격 및 정보 스크래핑
  - Option C: 논문 및 학술 연구 자료 요약
  - Option D: 지출 증빙 및 경비 감사 추적
- **강의 전달 팁:** 학생들의 참여를 유도하며 각 보기를 천천히 읽어주세요.

### 📚 Key Terms (주요 용어)
- **Workflow Delegation**: Assigning multi-step routine business processes to automated agents. (업무 프로세스 위임)
...
Look at the big number on Slide 9: "30%."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 행정적 세금(Administrative Tax) 절감과 창의적 비전 확보
- **핵심 포인트:**
...
- **강의 전달 팁:** 30% 숫자를 가리키며 활력 있는 목소리로 전달하세요.

### 📚 Key Terms (주요 용어)
- **Administrative Tax**: The hidden productivity loss caused by manual, repetitive overhead tasks. (행정적 과세 / 비효율 잡무 손실)
...
Slide 10 presents our roadmap for today's lecture. We have four main stations to visit:
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Session 2 커리큘럼 로드맵 4대 스테이션 안내
- **핵심 포인트:**
...
- **강의 전달 팁:** 오늘 배울 4가지 테마를 손가락으로 하나씩 꼽으며 안내합니다.

### 📚 Key Terms (주요 용어)
- **Agent Roadmap**: The structured learning path covering infrastructure, design, and security. (에이전트 구축 로드맵)

---

## Slide 11: PART 2: UNDER THE HOOD OF THE ASYNCHRONOUS ENGINE
**Subtitle:** Demystifying TPU v8, Gemini 3.6 Flash, Spark OS, Dual Memory & Triad Design

### 🎙️ English Lecture Script

We now arrive at Part 2 of our lecture: "Under the Hood of the Asynchronous Engine."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 2 섹션 전환: 클라우드 하드웨어 및 시스템 엔진 심층 분석
- **핵심 포인트:**
  - 이론에서 실제 시스템 아키텍처로 진입
  - TPU v8, Gemini 3.6 Flash, Spark OS, Dual Memory 및 Triad 설계 탐구
- **강의 전달 팁:** 엔지니어링 파트로 넘어가는 기대감을 조성하며 또렷하게 발음하세요.

### 📚 Key Terms (주요 용어)
- **Asynchronous Engine**: The backend infrastructure enabling continuous agent background execution. (비동기 에이전트 엔진)

---

## Slide 12: GEMINI 3.6 FLASH: THE MICRO-REASONING ENGINE
**Subtitle:** High-throughput micro-reasoning for nested agent coordination

### 🎙️ English Lecture Script

Look at Slide 12: "Gemini 3.6 Flash: The Micro-Reasoning Engine."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Gemini 3.6 Flash 모델의 특장점: 초고속 마이크로 추론(Micro-Reasoning)
- **핵심 포인트:**
...
- **강의 전달 팁:** 에이전트끼리 대화할 때 속도가 왜 중요한지 쉽게 설명해 주세요.

### 📚 Key Terms (주요 용어)
- **Micro-Reasoning**: Fast, focused multi-step validation checks executed by lightweight LLMs. (마이크로 추론 (연속 경량 판단))
- **Nested Latency**: Accumulated response delays in multi-agent communication networks. (중첩 지연시간)

---

## Slide 13: TPU V8: THE GREEN SUSTAINABLE MUSCLE
**Subtitle:** Eco-friendly supercomputing muscle for continuous 24/7 reasoning

### 🎙️ English Lecture Script

On Slide 13, we look at the physical hardware: "TPU v8: The Green Sustainable Muscle."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 TPU v8 하드웨어의 연산 성능 및 친환경 에너지 효율성
- **핵심 포인트:**
  - 연산 성능 3배 향상: TPU v7 대비 300% 강력해진 AI 추론 전용 칩셋
  - 전력 소비 67% 감소: 24시간 연산 가동 시 탄소 배출을 획기적으로 줄이는 친환경 설계
  - 지속 가능한 AI: 인프라 수준의 친환경 그리드 구현
- **강의 전달 팁:** 차트의 노란색과 청록색 막대를 가리키며 성능 향상과 절전을 비교해 주세요.

### 📚 Key Terms (주요 용어)
- **TPU v8**: Google's 8th-generation Tensor Processing Unit built for eco-friendly AI inference. (TPU v8 (구글 8세대 AI 전용 가속기))

---

## Slide 14: SPARK OS: ESTABLISHING THE AGENT'S DESK
**Subtitle:** Establishing the persistent workspace home in Google Drive

### 🎙️ English Lecture Script

Please look at Slide 14: "Spark OS: Establishing the Agent's Desk."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 드라이브 루트 내 /Spark_OS/ 에이전트 전용 디렉터리 구조
- **핵심 포인트:**
...
- **강의 전달 팁:** 신입 비서에게 책상을 마련해 주는 비유를 들어 설명해 주세요.

### 📚 Key Terms (주요 용어)
- **Spark OS Directory**: The standardized Google Drive directory layout for persistent agent file operations. (스파크 OS 디렉터리 아키텍처)

---

## Slide 15: OVERCOMING AMNESIA: DUAL-MEMORY ENGINE
**Subtitle:** Combining short-term working context with long-term persistent storage

### 🎙️ English Lecture Script

Slide 15 addresses a common headache in AI: "Amnesia." Amnesia means forgetting everything!
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** AI 건망증 극복을 위한 이중 메모리 엔진 (Context Window + Spark OS DB)
- **핵심 포인트:**
...
- **강의 전달 팁:** 어제 한 말을 오늘 다 까먹는 챗봇의 답답함을 언급하며 공감대를 만드세요.

### 📚 Key Terms (주요 용어)
- **Dual-Memory Engine**: An architecture coupling short-term context window with persistent database storage. (이중 메모리 엔진 (단기+장기 기억 체계))

---

## Slide 16: OPERATIONAL PREREQUISITES CHECKLIST
**Subtitle:** Four essentials for secure Google Cloud handshake

### 🎙️ English Lecture Script

Look at Slide 16 for our "Operational Prerequisites Checklist."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 가동을 위한 4대 필수 사전점검 체크리스트
- **핵심 포인트:**
  - 1. 개인 구글 계정 및 제미나이 어드밴스드/울트라 구독 권한
  - 2. 클라우드 핸드셰이크를 위한 만 18세 이상 보안 인증
  - 3. 구글 드라이브 루트 내 /Spark_OS/ 폴더 정상 생성 완료
- **강의 전달 팁:** 체크리스트 3가지를 명확하고 깔끔하게 짚어주세요.

### 📚 Key Terms (주요 용어)
- **Operational Prerequisites**: Required account, age, and directory setups before agent deployment. (운영 사전 조건)
...
Now, please pay very close attention to Slide 17. This is the heart of our entire course: "The Triad of Agentic Design."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전틱 IT의 핵심 3대 기둥: Task(목표), Schedule(시점), Skill(규칙)
- **핵심 포인트:**
...
- **강의 전달 팁:** 삼각형 3개 기둥의 중요성을 강조하며 수강생들의 주의를 집중시키세요.

### 📚 Key Terms (주요 용어)
- **Triad of Agentic Design**: The foundational framework defining Task, Schedule, and Skill parameters. (에이전트 설계의 트라이아드 (3대 기둥))
...
Let us look at Pillar 1 on Slide 18: "The Task Framework."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기둥 1: Task (목표 프레임워크) - 결과물 중심의 목표 정의
- **핵심 포인트:**
...
- **강의 전달 팁:** 버튼 클릭을 일일이 지시하지 말고 최종 결과물을 명확히 주라고 강조하세요.

### 📚 Key Terms (주요 용어)
- **Target End-State**: The final desired condition or output of an autonomous workflow. (목표 최종 상태 (Target End-State))
...
Slide 19 explains Pillar 2: "The Schedule Trigger."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기둥 2: Schedule (실행 시점 트리거) - 시간 기반 대 이벤트 기반
- **핵심 포인트:**
...
- **강의 전달 팁:** 시간 기반과 이벤트 기반의 차이를 일상적인 예시로 전달해 주세요.

### 📚 Key Terms (주요 용어)
- **Temporal Trigger**: A schedule based on specific clock times or recurring intervals. (시간 기반 트리거)
- **Event-Driven Trigger**: A trigger fired by system state changes like incoming emails or webhook signals. (이벤트 기반 트리거)

---

## Slide 20: PILLAR 3: THE SKILL INJECTION
**Subtitle:** Establishing custom tone, formatting rules, and behavioral boundaries

### 🎙️ English Lecture Script

Slide 20 explains Pillar 3: "The Skill Injection."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기둥 3: Skill (행동 및 어조 주입) - 에이전트 가이드라인 및 안전 경계
- **핵심 포인트:**
  - 어조(Tone): '단정하고 정중한 학술적 어조 유지' 등 소통 방식 지정
  - 출력 양식: 마크다운 포맷팅 및 표준 템플릿 준수 강제
  - 안전 경계(Guardrails): 미승인 결제나 정보 유출을 막는 행동 제약
- **강의 전달 팁:** 에이전트의 예절과 안전벨트 역할을 하는 Skill을 친절하게 설명하세요.

### 📚 Key Terms (주요 용어)
- **Skill Injection**: Embedding explicit behavioral rules, formatting guidelines, and tone into agent prompts. (스킬 주입 (행동/어조 제어 지침))

---

## Slide 21: PART 3: THE CONNECTED WORKSPACE: NATIVE CROSS-APP WORKFLOWS
**Subtitle:** Gmail parsing, Calendar blocks, Auto-Docs & Virgin Voyages Case Study

### 🎙️ English Lecture Script

Welcome to Part 3 of Session 2: "The Connected Workspace: Native Cross-App Workflows."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 3 섹션 전환: 구글 워크스페이스 앱 간 자율 워크플로우 실무
- **핵심 포인트:**
  - 지메일, 캘린더, 문서, 스프레드시트를 아우르는 기본 통합성
  - 버진 보이지스(Virgin Voyages) 실제 기업 사례 연구
- **강의 전달 팁:** 실생활 적용에 대한 기대감을 높이며 활기차게 섹션을 엽니다.

### 📚 Key Terms (주요 용어)
- **Cross-App Pipelines**: Workflows that pass data seamlessly across multiple office productivity apps. (크로스 앱 파이프라인)

---

## Slide 22: NATIVE CROSS-APP PIPELINES
**Subtitle:** Zero-API complexity across Google Workspace fabric

### 🎙️ English Lecture Script

Look at Slide 22: "Native Cross-App Pipelines."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 워크스페이스 내 Zero-API 방식의 연동 파이프라인
- **핵심 포인트:**
  - Zero-API 복잡성: 깨지기 쉬운 외부 파이프라인 없이 구글 자체 서비스 간 원활한 데이터 이동
  - 지메일 ➔ 문서 ➔ 시트 ➔ 캘린더로 이어지는 매끄러운 흐름
- **강의 전달 팁:** 구글 자체 앱 간 연동이 얼마나 안정적이고 편리한지 설명하세요.

### 📚 Key Terms (주요 용어)
- **Zero-API Complexity**: Direct native workspace integration avoiding fragile third-party API connectors. (Zero-API 복잡성 (자체 통합 구조))

---

## Slide 23: GMAIL PARSING AND CONTEXT EXTRACTION
**Subtitle:** Isolating key action items while filtering noise

### 🎙️ English Lecture Script

Slide 23 explains "Gmail Parsing and Context Extraction."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 지메일 파싱 및 문맥 추출 기술
- **핵심 포인트:**
  - 의도 인식: 고객 및 프로젝트 이메일에서 마감일과 요구사항 자동 파악
  - 잡음 제거: 프로모션, 뉴스레터, 단순 스팸 메시지 자동 차단
  - 핵심 액션 추출: 의사결정이 필요한 핵심 사안만 골라내어 정리
- **강의 전달 팁:** 이메일 홍수 속에서 핵심만 골라내는 편리함을 강조합니다.

### 📚 Key Terms (주요 용어)
- **Context Extraction**: Identifying and isolating essential actionable data from long unstructured text. (문맥 추출 (Context Extraction))

---

## Slide 24: DOCUMENT SYNTHESIS: AUTO-DOCS ENGINE
**Subtitle:** Translating raw data into clean, structured briefs

### 🎙️ English Lecture Script

Look at Slide 24: "Document Synthesis: Auto-Docs Engine."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 자동 문서 생성 엔진 (Auto-Docs Engine)
- **핵심 포인트:**
  - 구조화된 생성: 소제목과 핵심 요약이 정리된 정교한 구글 문서 작성
  - 자동 아카이빙: My Drive/Spark_OS/Outputs/ 폴더에 즉시 저장
  - 업무 효율성: 사람이 직접 작성할 필요 없는 보고서 완성
- **강의 전달 팁:** 채팅창 텍스트가 아닌 실제 구글 문서로 깔끔하게 저장됨을 짚어주세요.

### 📚 Key Terms (주요 용어)
- **Auto-Docs Engine**: An automated document generator creating formatted office docs from agent findings. (오토 도식스 엔진 (자율 문서 생성))

---

## Slide 25: CALENDAR MAPPING & COGNITIVE DEFENSE
**Subtitle:** Shielding high-value hours with automated Focus Blocks

### 🎙️ English Lecture Script

Slide 25 introduces one of my personal favorites: "Cognitive Defense."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 캘린더 연동을 통한 인지 방어막(Cognitive Defense)과 집중 시간 확보
- **핵심 포인트:**
  - Left: 무분별한 회의 요청으로 파편화된 일정과 집중력 저하
  - Right: 마감일에 맞춰 자동으로 '포커스 블록'을 예약하여 몰입 시간을 보호하는 에이전트
  - 목적: 인간의 가장 창의적인 시간을 외부 침범으로부터 수호
- **강의 전달 팁:** 일정 경호원(Schedule bodyguard)이라는 재미있는 표현을 활용하세요.

### 📚 Key Terms (주요 용어)
- **Cognitive Defense**: Automated schedule protection reserving uninterrupted time for deep focus. (인지 방어막 (몰입 시간 수호))

---

## Slide 26: CHROME AUTO-BROWSING: BEYOND THE GOOGLE GARDEN
**Subtitle:** Extending autonomous reach to third-party web services

### 🎙️ English Lecture Script

On Slide 26, we explore "Chrome Auto-Browsing."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 크롬 오토 브라우징(Chrome Auto-Browsing)을 통한 외부 웹 데이터 수집
- **핵심 포인트:**
  - 샌드박스 브라우저: 안전한 가상 브라우저 세션을 띄워 웹 탐색 수행
  - 심층 데이터 수집: 경쟁사 가격, 행사 일정, 해외 학술 자료 자동 스크래핑
  - 폼 자동화: 다단계 회원가입 및 데이터 조회 폼을 자율적으로 조작
- **강의 전달 팁:** 구글 외부 웹사이트까지 안전하게 탐색하는 기능임을 전달하세요.

### 📚 Key Terms (주요 용어)
- **Chrome Auto-Browsing**: Automated browser navigation simulating human interaction on web pages. (크롬 오토 브라우징)

---

## Slide 27: CASE STUDY: THE VIRGIN VOYAGES MIRACLE
**Subtitle:** From 6 hours of manual processing down to 11 minutes

### 🎙️ English Lecture Script

Slide 27 shows a wonderful real-world case study: "The Virgin Voyages Miracle."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 버진 보이지스(Virgin Voyages) 기업 혁신 사례: 6시간 ➔ 11분 단축
- **핵심 포인트:**
  - 기존 수작업: 크루즈 예약 변경에 상담원당 6시간(360분) 소요
  - 에이전트 도입: Gemini 에이전트 조율을 통해 단 11분 만에 완수 (97% 시간 절감)
  - 교훈: 단순 지루한 업무의 단축이 고객 만족과 기업 경쟁력으로 직결됨
- **강의 전달 팁:** 차트의 360분과 11분 막대를 대조하며 감탄을 자아내도록 설명하세요.

### 📚 Key Terms (주요 용어)
- **Virgin Voyages Case Study**: A real enterprise benchmark demonstrating a 97% execution time reduction using AI agents. (버진 보이지스 혁신 사례)

---

## Slide 28: REAL-WORLD SCENARIO 1: SMART TRAVEL ASSISTANT
**Subtitle:** End-to-end itinerary automation from Gmail to Calendar

### 🎙️ English Lecture Script

Let us look at Scenario 1 on Slide 28: "The Smart Travel Assistant."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실무 시나리오 1: 스마트 여행 및 출장 비서 에이전트
- **핵심 포인트:**
  - 1 단계: 지메일로 호텔 예약 확인서 수신 감지
  - 2 단계: 체크인/체크아웃 시간을 구글 캘린더에 자동 입력
  - 3 단계: 숙소 반경 1마일 내 맛집을 조사하여 /Spark_OS/Outputs/에 보고서 저장
- **강의 전달 팁:** 출장이나 여행 시 일어나는 편리한 과정을 스토리텔링으로 전하세요.

### 📚 Key Terms (주요 용어)
- **Itinerary Automation**: Autonomous parsing and scheduling of travel bookings into structured events. (여정 자동화)

---

## Slide 29: REAL-WORLD SCENARIO 2: GHOSTWRITER EMAIL AUTOMATION
**Subtitle:** Drafting replies in custom tone for human review

### 🎙️ English Lecture Script

Scenario 2 on Slide 29 is "Ghostwriter Email Automation."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실무 시나리오 2: 고스트라이터 이메일 초안 자동 작성 비서
- **핵심 포인트:**
  - 어조 학습: 과거 보낸 편지함을 분석하여 사용자의 고유한 어조 모사
  - 초안 합성: 고객 문의에 대한 정중하고 완벽한 답장 작성
  - 임시보관함 대기: 최종 발송 전 인간의 확인을 받도록 Gmail 임시보관함에 보존
- **강의 전달 팁:** 임시보관함(Drafts)에 대기시켜 안전성을 확보한다는 점을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Ghostwriter Skill**: An agent skill emulating the user's specific writing style to draft communications. (고스트라이터 스킬 (어조 모사 작성))

---

## Slide 30: REAL-WORLD SCENARIO 3: WEEKLY STRATEGIC REVIEW
**Subtitle:** Automated Monday morning executive briefings

### 🎙️ English Lecture Script

Slide 30 shows Scenario 3: "The Weekly Strategic Review."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실무 시나리오 3: 매주 월요일 아침 주간 전략 브리핑 자동화
- **핵심 포인트:**
  - 정기 트리거: 매주 월요일 오전 8시 비동기 자동 가동
  - 다중 소스 수집: 슬랙, 지메일, 구글 문서의 중요 프로젝트 이슈 병합
  - 1페이지 요약 보고: 출근 직후 바로 읽을 수 있는 전략 기획안 작성
- **강의 전달 팁:** 월요일 아침 출근길의 여유로움을 연상시키며 설명하세요.

### 📚 Key Terms (주요 용어)
- **Executive Briefing**: A high-level aggregated report summarizing key priorities across tools. (주간 전략 브리핑)

---

## Slide 31: PART 4: SECURING THE DIGITAL VAULT: GOVERNANCE & SAFETY
**Subtitle:** AP2 Protocol, Digital Mandates, Prompt Injection Firewalls & HOTL

### 🎙️ English Lecture Script

We now enter our final chapter, Part 4: "Securing the Digital Vault: Governance & Safety."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 4 섹션 전환: 거버넌스, 디지털 보안 및 인간의 주권(HOTL)
- **핵심 포인트:**
  - AP2 결제 프로토콜, 디지털 위임 계약, 프롬프트 인젝션 방어
  - Human-on-the-Loop 모델과 Soli Deo Gloria의 최종 가치
- **강의 전달 팁:** 진중하고 신뢰감 있는 톤으로 보안의 중요성을 환기시킵니다.

### 📚 Key Terms (주요 용어)
- **Governance & Safety**: The structural protocols ensuring AI agents operate within secure ethical boundaries. (에이전트 거버넌스 및 보안)

---

## Slide 32: THE RISK OF THE UNCONTROLLED WALLET
**Subtitle:** Establishing financial guardrails for autonomous commerce

### 🎙️ English Lecture Script

Look at Slide 32: "The Risk of the Uncontrolled Wallet."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 통제되지 않은 지갑(Uncontrolled Wallet)의 위협과 금융 제약
- **핵심 포인트:**
...
- **강의 전달 팁:** 지갑을 함부로 맡기면 안 된다는 경고를 진지하게 전하세요.

### 📚 Key Terms (주요 용어)
- **Uncontrolled Wallet Risk**: The financial risk of unconstrained autonomous agent purchases. (통제되지 않은 결제 위협)

---

## Slide 33: AP2: AGENT PAYMENTS PROTOCOL
**Subtitle:** Standardized financial handshake for autonomous AI entities

### 🎙️ English Lecture Script

Slide 33 introduces Google's standard: "AP2 — Agent Payments Protocol."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 AP2 (Agent Payments Protocol) 결제 프로토콜
- **핵심 포인트:**
...
- **강의 전달 팁:** 실제 카드번호 대신 임시 토큰으로 거래한다는 핵심 원리를 밝히세요.

### 📚 Key Terms (주요 용어)
- **AP2 Protocol**: Agent Payments Protocol: Google's secure payment framework for autonomous AI entities. (AP2 (에이전트 전용 자율 결제 프로토콜))

---

## Slide 34: DESIGNING THE DIGITAL MANDATE
**Subtitle:** Programmatic contracts governing spending authority

### 🎙️ English Lecture Script

Slide 34 explains the "Digital Mandate."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 디지털 위임장 (Digital Mandate) 기획 및 제약 파라미터
- **핵심 포인트:**
  - 예산 한도(Budget Cap): 단일 거래당 최대 결제 금액 한도 설정 (예: 최대 $50)
  - 가맹점 화이트리스트: 미리 검증된 쇼핑몰/업체 도메인에서만 결제 허용
  - 만료 시한: 특정 시간이 지나면 위임 권한이 자동 소멸하는 안전 계약
- **강의 전달 팁:** 디지털 위임장이 에이전트의 안전 고삐 역할을 한다는 점을 설명하세요.

### 📚 Key Terms (주요 용어)
- **Digital Mandate**: A programmatic contract restricting an agent's financial spending authority. (디지털 위임 계약서)

---

## Slide 35: HUMAN NOT PRESENT (HNP) TRANSACTIONS
**Subtitle:** Autonomous machine-to-machine commerce at scale

### 🎙️ English Lecture Script

Slide 35 covers "Human Not Present (HNP) Transactions."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 무인 결제(Human Not Present - HNP) 거래와 암호화 감사 기록
- **핵심 포인트:**
  - 새벽 자율 거래: 사용자가 잘 때 새벽 3시에도 안전하게 결제 수행
  - 암호화 서명: 거래의 진위 여부를 증명하는 디지털 서명 생성
  - 감사 기록 아카이빙: /Spark_OS/Logs/ 폴더에 영수증과 내역 자동 저장
- **강의 전달 팁:** 새벽에도 안전하게 거래가 체결되고 기록이 남는 신뢰성을 전하세요.

### 📚 Key Terms (주요 용어)
- **Human Not Present (HNP)**: Transactions executed autonomously by machine agents without real-time human presence. (무인 결제 거래 (Human Not Present))

---

## Slide 36: THE THREAT OF PROMPT INJECTION
**Subtitle:** Protecting agent instruction layers from untrusted external data

### 🎙️ English Lecture Script

Look at Slide 36: "The Threat of Prompt Injection."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 프롬프트 인젝션(Prompt Injection) 공격 위협과 지침 격리 방화벽
- **핵심 포인트:**
...
- **강의 전달 팁:** 해킹 예시를 생생하게 들어 지침 격리의 필요성을 전달하세요.

### 📚 Key Terms (주요 용어)
- **Prompt Injection**: A security vulnerability where malicious input overrides an AI model's instructions. (프롬프트 인젝션 (악의적 지시 오버라이드 공격))

---

## Slide 37: MITIGATING THE RISKS: SAFE PURGE PROTOCOLS
**Subtitle:** Data hygiene and key security for cloud operations

### 🎙️ English Lecture Script

Slide 37 outlines "Safe Purge Protocols."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 안전한 데이터 소거(Safe Purge Protocols) 및 위협 완화 3대 수칙
- **핵심 포인트:**
  - 1. 정기적 브라우저 세션 및 임시 변수 캐시 소거
  - 2. API 키의 오프라인 안전 보관 및 공개 코드 저장소 유출 방지
  - 3. 파일 접근 범위를 /Spark_OS/ 폴더 내부로 엄격히 제한
- **강의 전달 팁:** 디지털 위생 관리 3대 수칙을 명확하게 짚어줍니다.

### 📚 Key Terms (주요 용어)
- **Safe Purge Protocol**: Regular automated deletion of transient logs and browser cache data to prevent data leakage. (안전 데이터 소거 프로토콜)

---

## Slide 38: THE SOVEREIGN CONDUCTOR: HUMAN-ON-THE-LOOP (HOTL)
**Subtitle:** Retaining ultimate human oversight and strategic veto loops

### 🎙️ English Lecture Script

On Slide 38, we emphasize our true role: "The Sovereign Conductor (Human-on-the-Loop)."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 주권적 지휘자: Human-on-the-Loop (HOTL) 모델과 최종 비토 권한
- **핵심 포인트:**
...
- **강의 전달 팁:** 지휘봉을 쥐는 자세로 'You are the conductor'를 각인시켜 주세요.

### 📚 Key Terms (주요 용어)
- **Human-on-the-Loop (HOTL)**: A governance framework where human supervisors retain ultimate oversight and veto authority. (HOTL (인간 지휘관 거버넌스))

---

## Slide 39: SOLI DEO GLORIA: REDEEMING THE TIME
**Subtitle:** Transforming saved hours into creative service and spiritual depth

### 🎙️ English Lecture Script

Slide 39 brings us to our spiritual summit: "Soli Deo Gloria: Redeeming the Time."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Soli Deo Gloria: 절약된 시간의 숭고한 재투자와 참된 자유
- **핵심 포인트:**
  - 궁극적 목적: 게으름이 아닌, 진정한 창의적 자유와 사명을 위해 자동화함
  - 시간 구속: 매일 3~4시간의 기계적 잡무 노동에서 해방
  - 숭고한 재투자: 절약된 시간을 가족, 학문적 깊이, 이웃 섬김, 영성 깊이에 투자
- **강의 전달 팁:** 감동과 영감이 넘치는 따뜻한 어조로 강의의 본질을 전하세요.

### 📚 Key Terms (주요 용어)
- **Soli Deo Gloria**: Glory to God Alone: The foundational motto guiding purposeful IT automation. (Soli Deo Gloria (오직 하나님께 영광))

---

## Slide 40: LAB 2 ASSIGNMENT: ARCHITECTING YOUR SPARK OS BLUEPRINT
**Subtitle:** Design and deploy your first custom Spark Agent Blueprint (Due Week 3)

### 🎙️ English Lecture Script

We have reached the end of Session 2! Look at Slide 40 for your Lab 2 Homework Assignment due next week.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Lab 2 과제 안내: 나만의 스파크 에이전트 블루프린트 기획안 작성
- **핵심 포인트:**
...
- **강의 전달 팁:** 과제 제출을 격려하며 밝은 미소로 수업을 마칩니다.

### 📚 Key Terms (주요 용어)
- **Spark Agent Blueprint**: A comprehensive design specification document defining Task, Schedule, and Skill. (스파크 에이전트 청사진 (Lab 2 과제))
