
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Soli Deo Gloria 신앙관과 인지적 방어(Cognitive Defense)
- **핵심 포인트:**
...
- **강의 전달 팁:** 품격 있고 진중한 어조로 광고 차단과 보안이 왜 신앙적 청지기직인지 설명하세요.

### 📚 Key Terms (주요 용어)
- **Cognitive Defense**: The active protection of human mental attention from manipulative commercial ad networks. (인지적 방어 (디지털 주의력 보호))
...
Please look at Slide 3: "Smart Insight Lab: The Browser as an Operating System."
...
- **강의 전달 팁:** 브라우저가 윈도우나 맥OS 위에 떠 있는 또 하나의 거대한 운영체제임을 강조하세요.
...
Slide 4 exposes a crucial misconception: "The Illusion of Transparency: Window versus Fortress."
...
- **강의 전달 팁:** 유리창을 깨고 들어오는 외부 코드를 방패로 막아내는 요새의 이미지를 생생히 묘사하세요.
...
Look at Slide 5: "The Browser's Three Architectural Pillars."
...
- **강의 전달 팁:** 세 기둥이 협력하여 속도와 보안을 동시에 달성하는 조화로운 구조를 설명하세요.
...
Slide 6 reveals a macro-level tech war: "First Keystroke: The Battle for Desktop Entry."
...
- **강의 전달 팁:** 컴퓨터를 켜자마자 어디에 검색어를 치는지 청중에게 질문하며 흥미를 유발하세요.
...
Look at Slide 7: "The V8 Engine Compilation Pipeline."
...
- **강의 전달 팁:** 인터프리터의 즉시 실행과 컴파일러의 초고속 성능이 결합된 하이브리드 구조를 설명하세요.
...
Slide 8 shows "The Parsing Phase: Weaving the Abstract Syntax Tree."
...
- **강의 전달 팁:** 평면적인 텍스트가 나무 모양의 논리 트리(AST)로 구조화되는 과정을 시각화해 주세요.
...
Look at Slide 9: "The Ignition Interpreter: Bytecode and Profiling."
...
- **강의 전달 팁:** 즉시 실행하면서 뒤로는 어떤 함수가 자주 쓰이는지 정탐하는 영리한 스파이 비유를 드세요.
...
Slide 10 details "The TurboFan JIT Compiler and the Deopt Trap."
...
- **강의 전달 팁:** 추측을 통해 초고속으로 달리다가 예외가 생기면 안전하게 속도를 낮추는 기차 비유를 드세요.
...
Welcome to Part 2: "Memory Management, Sandboxing, and Site Isolation."
...
- **강의 전달 팁:** 속도만큼 중요한 메모리 관리와 물리적 CPU 결함 방어의 세계로 이끌어 주세요.
...
Look at Slide 12: "Memory Lifecycles: Young versus Old Generations."
...
- **강의 전달 팁:** 금방 쓰고 버리는 종이컵(영 세대)과 오래 보관하는 도자기 그릇(올드 세대)의 비유를 드세요.
...
Slide 13 uses a lovely metaphor: "The Orinoco Garbage Collection Engine."
...
- **강의 전달 팁:** 손님의 대화를 방해하지 않는 깔끔한 웨이터의 이미지로 동시성 GC를 설명하세요.
...
Look at Slide 14: "Minor GC: The Dual-Space Copying Scavenger."
...
- **강의 전달 팁:** 두 개의 바구니를 두고 살아있는 물건만 새 바구니로 옮겨 담는 깔끔한 정리를 비유하세요.
...
Slide 15 explains "Major GC: The Mark-Sweep-Compact Pipeline."
...
- **강의 전달 팁:** 표시하고(Mark), 쓸어내고(Sweep), 빈틈없이 압축하는(Compact) 3단계를 손동작으로 보여주세요.
...
Look at Slide 16: "The Sandbox Principle: Caging Untrusted Code."
...
- **강의 전달 팁:** 호랑이를 동물원 특수 강화 우리(샌드박스) 안에 가두어 관람객(호스트 OS)을 보호하는 비유를 드세요.
...
Slide 17 explains "Privilege Separation: Renderer versus Browser Kernel."
...
- **강의 전달 팁:** 주방 보조(렌더러)가 칼이나 불을 쓸 때 반드시 총주방장(브라우저 프로세스)의 허락을 받는 구조를 설명하세요.
...
Look at Slide 18: "Spectre & Meltdown: Shattering Sandbox Walls."
...
- **강의 전달 팁:** 벽 너머의 소리를 청진기로 엿듣듯 CPU 캐시 시간차로 비밀을 훔쳐보는 스펙터의 공포를 전하세요.
...
Slide 19 reveals Google's masterstroke: "Site Isolation."
...
- **강의 전달 팁:** 방을 칸막이로 나눈 것이 아니라 완전히 다른 건물(프로세스)로 이사 보내어 도청을 차단한 원리를 설명하세요.
...
Look at the number on Slide 20: "The 10% RAM Tax."
...
- **강의 전달 팁:** 크롬이 램을 많이 먹는 이유가 사실은 우리를 해킹으로부터 지키기 위한 보안 세금이었음을 밝히세요.
...
We now open Part 3: "The Manifest V3 Extension Revolution."
...
- **강의 전달 팁:** 보안 강화라는 명분과 광고 차단기 무력화라는 실리가 충돌하는 흥미진진한 논쟁으로 안내하세요.
...
Slide 22 examines the "Anatomy of Extension Execution in Manifest V2."
...
- **강의 전달 팁:** 24시간 켜져 있는 백그라운드 페이지가 배터리를 갉아먹는 주범이었음을 설명하세요.
...
Look at Slide 23 for a terrifying vulnerability: "The Manifest V2 Remote Code Execution Hole."
...
- **강의 전달 팁:** 착한 양의 탈을 쓰고 들어와 나중에 늑대의 코드를 다운받던 V2의 허점을 경고하세요.
...
Slide 24 details another major flaw: "Insecure Message Passing."
...
- **강의 전달 팁:** 내부 직원인 척 가짜 서류를 올려 결재를 받아내는 스파이 작전에 비유하세요.
...
Look at Slide 25: "The Declaration of Manifest V3: Three Core Mandates."
...
- **강의 전달 팁:** 보안 취약점을 근본적으로 뜯어고치기 위한 V3의 3대 개혁 조치를 명확히 제시하세요.
...
Slide 26 compares "Background Pages versus Ephemeral Service Workers."
...
- **강의 전달 팁:** 밤새 시동을 켜둔 자동차(V2)와 시동 버튼을 누를 때만 켜지는 하이브리드 차(V3)의 비유를 드세요.
...
Look at Slide 27: "Network Control: webRequest versus declarativeNetRequest (DNR)."
...
- **강의 전달 팁:** 경찰관이 모든 편지를 직접 뜯어보던 방식(V2)에서 블랙리스트 주소만 우체국이 반송하는 방식(V3)으로의 변화를 설명하세요.
...
Slide 28 reveals the dark side of this transition: "The Demise of uBlock Origin."
...
- **강의 전달 팁:** 보안 명분 뒤에 숨겨진 광고 차단 기술 무력화의 실상을 솔직하게 지적하세요.
...
Look at Slide 29: "DNR Rule Limitations & The JSON Schema Gate."
...
- **강의 전달 팁:** 30만 개의 방패가 필요한데 3만 개만 쓰라고 제한하는 구조적 한계를 강조하세요.
...
Slide 30 compares "uBlock Origin Classic versus uBlock Origin Lite."
...
- **강의 전달 팁:** 방패가 가벼워진 대신 화살을 막아내는 면적이 좁아진 상황을 비유로 전하세요.
...
We now enter Part 4: "Platform Hegemony and Cognitive Sovereignty."
...
- **강의 전달 팁:** 빅테크 기업의 비즈니스 모델과 개인의 주체적 주권 사이의 관계를 거시적으로 조망하세요.
...
Look at Slide 32: "Google's Dual Identity: Guardian versus Advertising Giant."
...
- **강의 전달 팁:** 구글의 양면적 입장을 객관적인 비즈니스 모델 분석 관점에서 흥미롭게 설명하세요.
...
Slide 33 outlines "The Ad-Blocker Suppression Backlash."
...
- **강의 전달 팁:** 글로벌 규제 당국과 사용자들의 거대한 반발 움직임을 생생히 전달하세요.
...
Look at Slide 34: "Strategic Alternatives: Firefox's Rebel Path."
...
- **강의 전달 팁:** 독점 플랫폼에 맞서 사용자의 자유를 지키려는 파이어폭스의 반항아적 매력을 강조하세요.
...
Slide 35 examines another engineering triumph: "Brave Browser: Native C++ Shields."
...
- **강의 전달 팁:** 확장 프로그램 껍데기가 아니라 엔진 심장부에 티타늄 방패를 심어놓은 브레이브의 기술을 설명하세요.
...
Look at Slide 36: "Cognitive Sovereignty: Reclaiming Your Mind."
...
- **강의 전달 팁:** 광고 차단이 단순한 편의가 아니라 정신적 자유를 지키는 주권적 행위임을 강조하세요.
...
Slide 37 returns to our foundational scripture: "Redeeming the Time: Proactive Digital Stewardship."
...
- **강의 전달 팁:** 목회자적 진정성으로 시간과 집중력의 영적 가치를 마음에 새겨주세요.
...
Look at Slide 38 for your Hands-on Lab 9 Assignment: "Auditing Extension Manifests."
...
- **강의 전달 팁:** 학생들이 직접 보안 감사관이 되어 확장 프로그램을 분해하고 검증하는 실습을 안내하세요.
...
Slide 39 presents our strict Lab 9 Evaluation Rubric:
...
- **강의 전달 팁:** 명확한 3대 평가 기준을 제시하여 완성도 높은 리포트를 제출하도록 이끌어 주세요.
...
That brings us to the conclusion of Session 9! Look at Slide 40 for our next summit.
...
- **강의 전달 팁:** 다음 주 10강의 에이전트 군집 오케스트레이션에 대한 기대감을 최고조로 끌어올리며 마무리하세요.
