# Session 5: Enterprise Drive Mastery & GAS Automation
...
- [Slide 02: PART 1: THE ENTERPRISE DRIVE REVOLUTION & KNOWLEDGE VAULT](#slide-02-part-1-the-enterprise-drive-revolution-knowledge-vault)
- [Slide 03: SMART INSIGHT LAB: CORPORATE MEMORY](#slide-03-smart-insight-lab-corporate-memory)
- [Slide 04: THE SILENT DRAIN: TRIBAL KNOWLEDGE](#slide-04-the-silent-drain-tribal-knowledge)
- [Slide 05: THE TRAGEDY OF PERSONAL DRAWERS](#slide-05-the-tragedy-of-personal-drawers)
- [Slide 06: THE 20-DAY COUNTDOWN](#slide-06-the-20-day-countdown)
- [Slide 07: SYSTEM OWNERSHIP: SHARED DRIVES](#slide-07-system-ownership-shared-drives)
- [Slide 08: INTERACTIVE POLL: WHERE ARE YOUR FILES?](#slide-08-interactive-poll-where-are-your-files)
- [Slide 09: ANALYZING THE POLL: THE COST OF SEARCH](#slide-09-analyzing-the-poll-the-cost-of-search)
- [Slide 10: SESSION 5 AGENDA & ROADMAP](#slide-10-session-5-agenda-roadmap)
- [Slide 11: PART 2: DECONSTRUCTING THE SYSTEM VAULT](#slide-11-part-2-deconstructing-the-system-vault)
- [Slide 12: FILE STREAMING VS. FILE MIRRORING](#slide-12-file-streaming-vs-file-mirroring)
- [Slide 13: FILE STREAMING: VIRTUAL 0MB EFFICIENCY](#slide-13-file-streaming-virtual-0mb-efficiency)
- [Slide 14: FILE MIRRORING: OFFLINE REDUNDANCY](#slide-14-file-mirroring-offline-redundancy)
- [Slide 15: FOLDER COLOR CODING & TAXONOMY](#slide-15-folder-color-coding-taxonomy)
- [Slide 16: THE ART OF CHRONOLOGICAL NAMING](#slide-16-the-art-of-chronological-naming)
- [Slide 17: WEB-NATIVE VELOCITY: DOCS.NEW SHORTCUTS](#slide-17-web-native-velocity-docs-new-shortcuts)
- [Slide 18: BEYOND FILE NAMES: SMART SEARCH OPERATORS](#slide-18-beyond-file-names-smart-search-operators)
- [Slide 19: AI OCR INTEGRATION: DARK IMAGES TO LIVE ASSETS](#slide-19-ai-ocr-integration-dark-images-to-live-assets)
- [Slide 20: CASE STUDY: THE LOST MANUAL RECOVERY](#slide-20-case-study-the-lost-manual-recovery)
- [Slide 21: PART 3: STRATEGIC IMPERATIVES & RISK GOVERNANCE](#slide-21-part-3-strategic-imperatives-risk-governance)
- [Slide 22: THE LEAST PRIVILEGE PRINCIPLE](#slide-22-the-least-privilege-principle)
- [Slide 23: DECONSTRUCTING ROLES: VIEWER VS. COMMENTER](#slide-23-deconstructing-roles-viewer-vs-commenter)
- [Slide 24: OPERATIONAL SAFETY: CONTRIBUTOR VS. CONTENT MANAGER](#slide-24-operational-safety-contributor-vs-content-manager)
- [Slide 25: THE ULTIMATE GUARDIANS: SHARED DRIVE MANAGERS](#slide-25-the-ultimate-guardians-shared-drive-managers)
- [Slide 26: DATA EXFILTRATION DEFENSE](#slide-26-data-exfiltration-defense)
- [Slide 27: VERSION HISTORY & FORENSIC AUDITING](#slide-27-version-history-forensic-auditing)
- [Slide 28: STORAGE FINOPS: QUOTAS & TRASH PURGES](#slide-28-storage-finops-quotas-trash-purges)
- [Slide 29: SINGLE SOURCE OF TRUTH: WORKSPACE ADD-ONS](#slide-29-single-source-of-truth-workspace-add-ons)
- [Slide 30: CASE STUDY: PREVENTING A $50K DATA BREACH](#slide-30-case-study-preventing-a-50k-data-breach)
- [Slide 31: PART 4: WISDOM SYNTHESIS & APPS SCRIPT AUTOMATION](#slide-31-part-4-wisdom-synthesis-apps-script-automation)
- [Slide 32: GOOGLE APPS SCRIPT: THE INVISIBLE LABORER](#slide-32-google-apps-script-the-invisible-laborer)
- [Slide 33: TRIGGER-BASED AUTOMATION PIPELINES](#slide-33-trigger-based-automation-pipelines)
- [Slide 34: OVERCOMING COGNITIVE FATIGUE](#slide-34-overcoming-cognitive-fatigue)
- [Slide 35: COLLABORATIVE VELOCITY: @MENTIONS & COMMENTS](#slide-35-collaborative-velocity-mentions-comments)
- [Slide 36: SUGGESTION MODE: NON-DESTRUCTIVE EDITING](#slide-36-suggestion-mode-non-destructive-editing)
- [Slide 37: FROM PERSONAL EGO TO SYSTEM ASSET](#slide-37-from-personal-ego-to-system-asset)
- [Slide 38: REDEEMING THE TIME: COGNITIVE FREEDOM](#slide-38-redeeming-the-time-cognitive-freedom)
- [Slide 39: SOLI DEO GLORIA: COMMITTING WORK TO ETERNAL PURPOSE](#slide-39-soli-deo-gloria-committing-work-to-eternal-purpose)
- [Slide 40: LAB 5 ASSIGNMENT: GAS-POWERED SHARED VAULT](#slide-40-lab-5-assignment-gas-powered-shared-vault)
...
Good evening, everyone! Welcome back to Oikos University, my brilliant students and future intelligence architects. My name is Professor Peter Kim, and it is a true pleasure to welcome you to Session 5 of our master course: "The Architect of Intelligence."
...
- **강의 요약:** Session 5 개요 및 엔터프라이즈 구글 드라이브 마스터리 환영 인사
- **핵심 포인트:**
...
- **강의 전달 팁:** 밝고 힘찬 어조로 인사를 건네며, 파일 시스템 정리가 왜 기업의 생존을 결정짓는 핵심 아키텍처인지 강조하세요.

### 📚 Key Terms (주요 용어)
- **System Vault**: A centralized, persistent cloud storage architecture owned collectively by an organization. (시스템 금고 (전사적 영속 스토리지))
- **Google Apps Script (GAS)**: A cloud-based JavaScript runtime environment for automating Google Workspace workflows. (구글 앱스 스크립트 (GAS 클라우드 자동화))

---

## Slide 02: PART 1: THE ENTERPRISE DRIVE REVOLUTION & KNOWLEDGE VAULT
**Subtitle:** Soli Deo Gloria: Bringing divine order out of enterprise data chaos

### 🎙️ English Lecture Script

We now open Part 1 of Session 5: "The Enterprise Drive Revolution & Knowledge Architecture."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 1 섹션 전환: 엔터프라이즈 드라이브 혁명과 지식 볼트(Vault)
- **핵심 포인트:**
  - 질서는 하늘의 첫 번째 법칙: 어지럽게 널려 있는 기업 문서의 혼돈을 거룩한 질서로 재편
  - 구글 드라이브를 단순 저장소를 넘어 전사적 지식 요새로 탈바꿈시키는 폴더 분류 체계와 권한 거버넌스
- **강의 전달 팁:** 파일을 찾아 헤매는 시간 낭비를 끝내고 체계적인 지식 금고를 구축하는 쾌감을 전하세요.

### 📚 Key Terms (주요 용어)
- **Enterprise Knowledge Vault**: A structured, secure cloud document architecture governed by strict role permissions and automated indexing. (엔터프라이즈 지식 볼트 (전사적 지식 요새))

---

## Slide 03: SMART INSIGHT LAB: CORPORATE MEMORY
**Subtitle:** The three architectural pillars protecting an organization from institutional amnesia

### 🎙️ English Lecture Script

Please look at Slide 3: "Smart Insight Lab: The Architecture of Corporate Memory."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 스마트 인사이트 랩의 기업 기억(Corporate Memory) 3대 아키텍처
- **핵심 포인트:**
...
- **강의 전달 팁:** 기업의 지식이 몇 사람의 머릿속에만 머무를 때 발생하는 조직적 건망증의 위험을 경고하세요.

### 📚 Key Terms (주요 용어)
- **Corporate Memory**: The cumulative body of data, knowledge, and historical decisions preserved by an organization. (기업 기억 (조직의 축적된 제도적 지식))
- **Institutional Amnesia**: The catastrophic loss of historical organizational knowledge when key personnel depart. (조직적 건망증 (핵심 인력 퇴사 시 지식 유실 현상))

---

## Slide 04: THE SILENT DRAIN: TRIBAL KNOWLEDGE
**Subtitle:** Word-of-mouth confusion vs. codified, searchable system vaults

### 🎙️ English Lecture Script

Look at Slide 4: "The Silent Drain: Tribal Knowledge and Orphaned Files."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구전 지식(Tribal Knowledge)의 낭비와 고아 파일(Orphaned Files) 문제
- **핵심 포인트:**
...
- **강의 전달 팁:** 선배에게 파일 위치를 일일이 물어봐야 했던 수강생들의 답답한 경험을 떠올리게 하세요.

### 📚 Key Terms (주요 용어)
- **Tribal Knowledge**: Unwritten information and operational rules known only to specific team members. (구전 지식 (문서화되지 않은 내부자 지식))
- **Orphaned Files**: Digital documents whose original creator account has been deleted or abandoned. (고아 파일 (소유자 계정 삭제로 방치된 파일))

---

## Slide 05: THE TRAGEDY OF PERSONAL DRAWERS
**Subtitle:** Why storing enterprise assets in 'My Drive' creates dangerous single points of failure

### 🎙️ English Lecture Script

Slide 5 exposes a critical structural flaw: "The Tragedy of Personal Drawers."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 개인 서랍(My Drive)의 비극과 팀 공유 드라이브(Shared Drive)의 해결책
- **핵심 포인트:**
...
- **강의 전달 팁:** 개인 서랍과 은행 대여금고의 차이를 비유로 들어 설명해 주세요.

### 📚 Key Terms (주요 용어)
- **My Drive vs Shared Drive**: The architectural distinction between user-owned cloud storage and organization-owned repositories. (내 드라이브 대 공유 드라이브 (소유권 모델 비교))

---

## Slide 06: THE 20-DAY COUNTDOWN
**Subtitle:** The Google Workspace deletion trap that erases corporate history overnight

### 🎙️ English Lecture Script

Slide 6 reveals a terrifying reality: "The 20-Day Countdown."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 워크스페이스의 20일 카운트다운(20-Day Countdown) 함정
- **핵심 포인트:**
...
- **강의 전달 팁:** 20일이라는 시한폭탄 숫자를 가리키며 경각심을 불러일으키세요.

### 📚 Key Terms (주요 용어)
- **20-Day Countdown**: Google Workspace's policy permanently purging deleted user My Drive data after 20 days. (20일 삭제 카운트다운 (구글 워크스페이스 영구 파기 주기))

---

## Slide 07: SYSTEM OWNERSHIP: SHARED DRIVES
**Subtitle:** Building persistent digital vaults owned by the organization, not the individual

### 🎙️ English Lecture Script

Look at Slide 7: "System Ownership: Shared Drives."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 공유 드라이브의 시스템 소유권(System Ownership) 3대 혜택
- **핵심 포인트:**
...
- **강의 전달 팁:** 사람이 바뀌어도 데이터는 굳건히 남는 공유 드라이브의 영속성을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Shared Drive Sovereignty**: An enterprise storage pattern ensuring files are anchored to organizational domains. (공유 드라이브 주권 (조직 소유 영속성))

---

## Slide 08: INTERACTIVE POLL: WHERE ARE YOUR FILES?
**Subtitle:** Where is your most critical project data saved right now?

### 🎙️ English Lecture Script

Let us pause for our first interactive check-in on Slide 8!
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실시간 청중 설문조사: 현재 가장 중요한 업무 데이터의 보관 위치
- **핵심 포인트:**
  - Option A: 개인 PC 로컬 바탕화면이나 다운로드 폴더
  - Option B: 개인 계정의 My Drive 클라우드 폴더
  - Option C: 팀 공유 드라이브 / 전사적 금고
  - Option D: 카카오톡, 슬랙, 이메일 첨부파일에 흩어짐
- **강의 전달 팁:** 학생들이 솔직하게 투표할 수 있도록 편안하고 유쾌한 분위기를 조성해 주세요.

### 📚 Key Terms (주요 용어)
- **Data Fragmentation**: The chaotic scattering of project files across incompatible devices and chat apps. (데이터 파편화 (분산 방치 현상))

---

## Slide 09: ANALYZING THE POLL: THE COST OF SEARCH
**Subtitle:** Searching for lost files consumes up to 20% of an employee's productive output

### 🎙️ English Lecture Script

Look at the big number on Slide 9: "20%."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 설문 분석: 파일 검색으로 낭비되는 20%의 일일 생산성 손실
- **핵심 포인트:**
...
- **강의 전달 팁:** 20%라는 숫자가 연간으로 환산하면 얼마나 거대한 손실인지 실감 나게 전하세요.

### 📚 Key Terms (주요 용어)
- **Search Tax**: The unproductive time lost by employees attempting to locate misplaced organizational files. (검색 세금 (파일 탐색으로 인한 생산성 손실))
...
Slide 10 presents our roadmap for today's lecture. We have four powerful stations to visit:
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Session 5 커리큘럼 로드맵 4대 스테이션 안내
- **핵심 포인트:**
  - 1. 동기화 아키텍처: 파일 스트리밍 대 미러링의 리소스 비교
  - 2. 시각적 분류 및 SOP: 폴더 색상 체계와 YYYYMMDD 연대기 명명 규칙
  - 3. 거버넌스 및 자동화: 5단계 권한 매핑 및 구글 앱스 스크립트(GAS) 트리거
- **강의 전달 팁:** 오늘 학습할 전체 흐름을 일목요연하게 짚어주며 기대감을 조성하세요.

### 📚 Key Terms (주요 용어)
- **Drive Roadmap**: The structured curriculum covering synchronization, folder SOP, security, and script automation. (드라이브 마스터리 로드맵)

---

## Slide 11: PART 2: DECONSTRUCTING THE SYSTEM VAULT
**Subtitle:** File Streaming vs. Mirroring, Folder Taxonomies, Smart Search, and Native AI OCR

### 🎙️ English Lecture Script

Welcome to Part 2 of Session 5: "Deconstructing the System Vault."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 2 섹션 전환: 시스템 금고 아키텍처 및 동기화 기술 심층 분석
- **핵심 포인트:**
  - 실무 엔지니어링 진입: 데스크톱 동기화 방식과 시각적 분류학
  - 스마트 검색 연산자 활용 및 구글 드라이브 자체 AI OCR 기능 탐구
- **강의 전달 팁:** 호기심을 자극하며 시스템 내부의 실질적 기술들을 흥미롭게 열어주세요.

### 📚 Key Terms (주요 용어)
- **System Vault Architecture**: The structural design of cloud synchronization, folder hierarchies, and OCR extractors. (시스템 금고 아키텍처)

---

## Slide 12: FILE STREAMING VS. FILE MIRRORING
**Subtitle:** Virtual cloud projection vs. physical local hard drive duplication

### 🎙️ English Lecture Script

Look at Slide 12: "File Streaming versus File Mirroring."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 파일 스트리밍(Streaming) 대 파일 미러링(Mirroring) 비교
- **핵심 포인트:**
...
- **강의 전달 팁:** 홀로그램(스트리밍)과 실물 복제(미러링)의 비유로 차이점을 명쾌히 설명하세요.

### 📚 Key Terms (주요 용어)
- **File Streaming**: A cloud storage method where files reside remotely and are cached locally only on-demand. (파일 스트리밍 (온디맨드 클라우드 가상화))
- **File Mirroring**: A synchronization method keeping an exact physical duplicate of all cloud files on local disk. (파일 미러링 (로컬 디스크 실물 복제))
...
Slide 13 highlights "File Streaming: Virtual 0MB Efficiency."
...
- **강의 전달 팁:** 10TB 용량의 자료를 가벼운 노트북에서 자유자재로 다루는 마법 같은 효율을 전하세요.

### 📚 Key Terms (주요 용어)
- **Holographic Storage**: Displaying complete cloud directory trees locally without storing raw file bytes on disk. (홀로그래픽 스토리지 가상화)
...
Look at Slide 14: "File Mirroring: Offline Redundancy."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 파일 미러링(Mirroring)의 오프라인 리던던시와 활용 시나리오
- **핵심 포인트:**
...
- **강의 전달 팁:** 비행기나 오지 출장 등 인터넷이 끊기는 특수 상황에서의 유용성을 설명하세요.

### 📚 Key Terms (주요 용어)
- **Offline Redundancy**: Maintaining local physical copies of cloud assets to ensure continuous operation without internet. (오프라인 리던던시 (무선 통신 두절 대비 복제))
...
Slide 15 covers a simple yet powerful design principle: "Folder Color Coding."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 폴더 색상 체계(Color Coding)와 시각적 인지 계층 구조
- **핵심 포인트:**
...
- **강의 전달 팁:** 회색 일색의 지루한 폴더를 색상별로 직관화하는 실무 팁을 전수하세요.

### 📚 Key Terms (주요 용어)
- **Pre-Attentive Visual Processing**: The subconscious, rapid visual recognition of colors and shapes before conscious thought. (사전 주의 시각 처리 (초고속 색상 식별 인지))
...
Look at Slide 16: "The Art of Chronological Naming."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 연대기적 명명 규칙: YYYYMMDD 표준 운영 절차(SOP)
- **핵심 포인트:**
...
- **강의 전달 팁:** 파일 이름 맨 앞에 날짜를 붙이는 단순한 습관이 얼마나 큰 체계성을 만드는지 강조하세요.

### 📚 Key Terms (주요 용어)
- **YYYYMMDD SOP**: A strict file-naming discipline placing year, month, and day at the beginning of filenames. (YYYYMMDD 명명 표준 운영 절차)
...
Slide 17 teaches you a pro-tip for speed: "Web-Native Velocity with .new Shortcuts."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 웹 네이티브 초고속 단축키: docs.new, sheets.new 활용법
- **핵심 포인트:**
...
- **강의 전달 팁:** 브라우저 주소창에 'docs.new'를 직접 쳐보는 시연을 안내하세요.

### 📚 Key Terms (주요 용어)
- **.new Domain Shortcuts**: Google's web-native top-level domain shortcuts for instant document creation. (.new 도메인 바로가기 (원클릭 문서 생성 단축키))
...
Look at Slide 18: "Beyond File Names: Smart Search Operators."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 드라이브 스마트 검색 연산자(Smart Search Operators) 마스터
- **핵심 포인트:**
...
- **강의 전달 팁:** 검색 연산자를 결합하여 원하는 문서를 1초 만에 찾아내는 기술을 전수하세요.

### 📚 Key Terms (주요 용어)
- **Search Operators**: Specialized syntax modifiers refining search queries by type, owner, date, and text content. (고급 검색 연산자 (정밀 타격 검색 구문))
...
Slide 19 reveals a built-in superpower: "Native AI OCR Integration."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 드라이브 내장 AI OCR을 통한 이미지 텍스트 자동 추출
- **핵심 포인트:**
...
- **강의 전달 팁:** 이미지를 구글 문서로 열기만 하면 텍스트가 추출되는 놀라운 기능을 꼭 실습하도록 안내하세요.

### 📚 Key Terms (주요 용어)
- **Google Docs Native OCR**: The built-in optical recognition feature converting uploaded images into editable Google Docs text. (구글 문서 자체 OCR (이미지-텍스트 변환 엔진))

---

## Slide 20: CASE STUDY: THE LOST MANUAL RECOVERY
**Subtitle:** Rescuing a critical machine failure from an unsearchable 1994 binder scan in 5 minutes

### 🎙️ English Lecture Script

Slide 20 presents a dramatic real-world case study: "The Lost Manual Recovery."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실제 위기 해결 사례: 1994년 구형 매뉴얼 스캔본의 5분 만의 OCR 복구
- **핵심 포인트:**
...
- **강의 전달 팁:** 5분 만에 공장을 멈춤 위기에서 구해낸 스토리텔링을 긴장감 있게 전달하세요.

### 📚 Key Terms (주요 용어)
- **Dark Data Recovery**: Rescuing mission-critical operational knowledge from unindexed legacy scanned files. (다크 데이터 복구 (레거시 스캔 자산화))

---

## Slide 21: PART 3: STRATEGIC IMPERATIVES & RISK GOVERNANCE
**Subtitle:** The Least Privilege Principle, Granular Role Mapping, and Anti-Exfiltration Shields

### 🎙️ English Lecture Script

We now cross into Part 3: "Strategic Imperatives and Risk Governance."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 3 섹션 전환: 전략적 보안 거버넌스 및 접근 제어
- **핵심 포인트:**
  - 최소 권한 원칙(Least Privilege)에 입각한 5단계 권한 매핑
  - 기밀 문서의 다운로드/인쇄/복사 방지 실드 및 버전 복구 포렌식
- **강의 전달 팁:** 신뢰감 있고 엄격한 최고 보안 책임자(CISO)의 시각으로 섹션을 시작하세요.

### 📚 Key Terms (주요 용어)
- **Risk Governance**: The structural policies preventing unauthorized access, data loss, and security breaches. (리스크 거버넌스 (보안 위험 통제 체계))

---

## Slide 22: THE LEAST PRIVILEGE PRINCIPLE
**Subtitle:** Granting users only the minimum access level required to fulfill their specific duties

### 🎙️ English Lecture Script

Look at Slide 22: "The Least Privilege Principle."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 최소 권한의 원칙(Principle of Least Privilege)과 5단계 권한 체계
- **핵심 포인트:**
...
- **강의 전달 팁:** 권한을 아끼는 것이 조직과 구성원 모두를 지키는 안전벨트임을 설명하세요.

### 📚 Key Terms (주요 용어)
- **Principle of Least Privilege**: A security standard granting users only the minimum access essential to perform their jobs. (최소 권한의 원칙 (Principle of Least Privilege))

---

## Slide 23: DECONSTRUCTING ROLES: VIEWER VS. COMMENTER
**Subtitle:** Passive consumers vs. interactive feedback reviewers

### 🎙️ English Lecture Script

Slide 23 compares our first two roles: "Viewer versus Commenter."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 열람자(Viewer)와 댓글 작성자(Commenter) 역할 분석
- **핵심 포인트:**
...
- **강의 전달 팁:** 두 역할의 적절한 실무 사용처를 예시를 들어 깔끔하게 비교해 주세요.

### 📚 Key Terms (주요 용어)
- **Viewer vs Commenter**: The distinction between passive readers and interactive feedback contributors. (열람자 대 댓글 작성자 권한)

---

## Slide 24: OPERATIONAL SAFETY: CONTRIBUTOR VS. CONTENT MANAGER
**Subtitle:** The critical security barrier preventing accidental directory deletions

### 🎙️ English Lecture Script

Look at Slide 24: "Operational Safety: Contributor versus Content Manager."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기여자(Contributor)와 콘텐츠 관리자(Content Manager)의 핵심 차이
- **핵심 포인트:**
...
- **강의 전달 팁:** Contributor가 삭제를 못하게 막아주는 최고의 안전장치임을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Contributor Role**: A Shared Drive permission allowing document creation and editing while barring deletions. (기여자 권한 (작성 가능, 삭제 불가 안전 권한))

---

## Slide 25: THE ULTIMATE GUARDIANS: SHARED DRIVE MANAGERS
**Subtitle:** Administrative dominion over membership lists, sharing policies, and system settings

### 🎙️ English Lecture Script

Slide 25 examines the highest tier: "Shared Drive Managers."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 공유 드라이브 관리자(Manager)와 2인 관리자 원칙(Rule of Two)
- **핵심 포인트:**
...
- **강의 전달 팁:** 관리자 권한을 소수(2명)로 엄격히 제한해야 하는 보안 이유를 밝히세요.

### 📚 Key Terms (주요 용어)
- **Rule of Two**: A security best practice restricting top administrative manager roles to a maximum of two individuals. (2인 관리자 원칙 (관리자 수 제한 보안 수칙))
...
Look at Slide 26: "Data Exfiltration Defense."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 데이터 유출 방지(Anti-Exfiltration): 다운로드/인쇄/복사 차단 실드
- **핵심 포인트:**
...
- **강의 전달 팁:** 기어 아이콘을 눌러 다운로드/인쇄 금지 체크박스를 켜는 실무 팁을 안내하세요.

### 📚 Key Terms (주요 용어)
- **Data Exfiltration Defense**: Technical controls preventing unauthorized downloading, copying, or printing of sensitive files. (데이터 유출 방지 (다운로드/인쇄 차단 기술))
...
Slide 27 presents "Version History and Forensic Auditing."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 버전 기록(Version History)과 포렌식 감사 롤백
- **핵심 포인트:**
...
- **강의 전달 팁:** 문서가 지워져도 당황하지 않고 버전 기록으로 되돌리는 안도감을 전하세요.

### 📚 Key Terms (주요 용어)
- **Version Rollback**: The ability to restore a document instantly to any historical state without data corruption. (버전 롤백 (과거 시점 복원))

---

## Slide 28: STORAGE FINOPS: QUOTAS & TRASH PURGES
**Subtitle:** Optimizing corporate cloud budgets with pooled storage and 30-day trash lifecycles

### 🎙️ English Lecture Script

Look at Slide 28: "Storage FinOps: Quotas and Trash Purges."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 스토리지 핀옵스(FinOps)와 30일 휴지통 영구 삭제 주기
- **핵심 포인트:**
...
- **강의 전달 팁:** 휴지통에 있는 파일도 용량을 차지한다는 점을 상기시키며 정기 관리의 중요성을 전달하세요.

### 📚 Key Terms (주요 용어)
- **Storage FinOps**: The financial management practice of optimizing cloud storage allocation and licensing costs. (스토리지 핀옵스 (클라우드 용량 비용 최적화))

---

## Slide 29: SINGLE SOURCE OF TRUTH: WORKSPACE ADD-ONS
**Subtitle:** Connecting Zoom, Trello, and DocuSign directly inside Google Drive without app switching

### 🎙️ English Lecture Script

Slide 29 teaches the principle of "The Single Source of Truth."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 단일 진실 공급원(Single Source of Truth)과 워크스페이스 애드온 통합
- **핵심 포인트:**
...
- **강의 전달 팁:** 앱들을 옮겨 다니며 파일을 중복 업로드하던 비효율을 없애는 팁을 전수하세요.

### 📚 Key Terms (주요 용어)
- **Single Source of Truth (SSOT)**: The practice of structuring data so that every document exists in exactly one authoritative location. (단일 진실 공급원 (SSOT - 유일 원본 유지 원칙))

---

## Slide 30: CASE STUDY: PREVENTING A $50K DATA BREACH
**Subtitle:** How download restrictions and forensic audit logs stopped an exfiltration attempt

### 🎙️ English Lecture Script

Look at Slide 30 for an alarming case study: "Preventing a $50,000 Data Breach."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실제 보안 사례: 다운로드 제한 정책으로 5만 달러 데이터 유출 방어
- **핵심 포인트:**
  - 유출 시도: 퇴사 예정 계약직원이 고객 데이터베이스 전체 반출 시도
  - 시스템 방어: '다운로드 금지' 정책으로 반출 시도 차단 및 감사 로그에 실시간 기록
  - 결과: 고객 데이터 보호 성공 및 5만 달러 상당의 규제 과징금 피해 예방
- **강의 전달 팁:** 작은 보안 옵션 하나가 기업의 운명을 가를 수 있음을 실감 나게 전하세요.

### 📚 Key Terms (주요 용어)
- **Forensic Audit Proof**: Indisputable digital logs proving unauthorized access attempts for legal compliance. (포렌식 감사 증거)

---

## Slide 31: PART 4: WISDOM SYNTHESIS & APPS SCRIPT AUTOMATION
**Subtitle:** Google Apps Script, Collaborative Velocity, Redeeming Time, and Lab 5 Assignment

### 🎙️ English Lecture Script

We now enter our final chapter, Part 4: "Wisdom Synthesis and Apps Script Automation."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Part 4 섹션 전환: 지혜의 종합 및 구글 앱스 스크립트(GAS) 자동화
- **핵심 포인트:**
  - 수동 정리자에서 자율 자동화 시스템의 지휘자로 전환
  - 구글 앱스 스크립트를 통한 24시간 백그라운드 파일 분류 및 로깅 자동화
- **강의 전달 팁:** 코딩을 통해 업무를 자동화하는 짜릿한 엔지니어링의 세계로 이끌어 주세요.

### 📚 Key Terms (주요 용어)
- **Robotic Automation**: Using server-side scripts to perform routine administrative workflows autonomously. (로보틱 자동화 (클라우드 스크립트 기반 자율 제어))

---

## Slide 32: GOOGLE APPS SCRIPT: THE INVISIBLE LABORER
**Subtitle:** A JavaScript-based cloud scripting runtime built natively into Google Workspace

### 🎙️ English Lecture Script

Look at Slide 32: "Google Apps Script: The Invisible Laborer."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 앱스 스크립트(GAS): 보이지 않는 로봇 노동자
- **핵심 포인트:**
...
- **강의 전달 팁:** 자바스크립트 몇 줄로 구글 앱 전체를 지휘하는 GAS의 강력함을 소개하세요.

### 📚 Key Terms (주요 용어)
- **Serverless Runtime**: An execution environment where cloud providers automatically manage server infrastructure. (서버리스 런타임 (클라우드 내장 스크립트 환경))

---

## Slide 33: TRIGGER-BASED AUTOMATION PIPELINES
**Subtitle:** Automating file categorization and master spreadsheet logging on events

### 🎙️ English Lecture Script

Slide 33 demonstrates a real "Trigger-Based Automation Pipeline."
...
- **강의 전달 팁:** 파일이 들어오자마자 시트에 정리되고 알림이 가는 자동화 과정을 생생하게 묘사하세요.

### 📚 Key Terms (주요 용어)
- **Event Trigger**: A programmatic condition executing automated script logic upon file creation or modification. (이벤트 트리거 (파일 생성 시 자동 발동 조건))

---

## Slide 34: OVERCOMING COGNITIVE FATIGUE
**Subtitle:** Rescuing human intellect from soul-crushing manual copy-paste cycles

### 🎙️ English Lecture Script

Look at Slide 34: "Overcoming Cognitive Fatigue."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 단순 복사-붙여넣기 노동 탈출과 인지적 피로(Cognitive Fatigue) 극복
- **핵심 포인트:**
...
- **강의 전달 팁:** 반복적인 복사-붙여넣기에 지쳤던 경험을 떠올리게 하며 해방감을 선사하세요.

### 📚 Key Terms (주요 용어)
- **Cognitive Fatigue**: Mental exhaustion caused by repetitive, non-creative manual data entry tasks. (인지적 피로 (단순 반복 노동으로 인한 뇌 피로))

---

## Slide 35: COLLABORATIVE VELOCITY: @MENTIONS & COMMENTS
**Subtitle:** Shortening decision cycles from days to minutes inside living cloud documents

### 🎙️ English Lecture Script

Slide 35 teaches "Collaborative Velocity with @Mentions."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** @멘션(@Mentions)을 통한 실시간 협업 속도(Collaborative Velocity)
- **핵심 포인트:**
...
- **강의 전달 팁:** 이메일 첨부파일 대신 본문 여백 댓글로 협업하는 현대적 방식을 강조하세요.

### 📚 Key Terms (주요 용어)
- **Document-Native Collaboration**: Conducting discussions and approvals directly inside cloud documents using @mentions. (문서 내장형 실시간 협업)

---

## Slide 36: SUGGESTION MODE: NON-DESTRUCTIVE EDITING
**Subtitle:** Transparent collaborative proposals without corrupting original text integrity

### 🎙️ English Lecture Script

Look at Slide 36: "Suggestion Mode: Non-Destructive Editing."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 제안 모드(Suggestion Mode)를 통한 비파괴적 협업 편집
- **핵심 포인트:**
...
- **강의 전달 팁:** 공동 작업 시 제안 모드를 기본으로 설정하는 협업 에티켓을 전수하세요.

### 📚 Key Terms (주요 용어)
- **Suggestion Mode**: A collaborative mode tracking proposed text edits without altering the original document directly. (제안 모드 (비파괴적 추적 편집))
...
Slide 37 asks for an essential mindset shift: "From Personal Ego to System Asset."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 개인의 에고에서 시스템 자산으로의 마인드셋 대전환
- **핵심 포인트:**
...
- **강의 전달 팁:** 지식을 독점하지 않고 조직의 공유 자산으로 승화시키는 성숙한 리더십을 역설하세요.

### 📚 Key Terms (주요 용어)
- **Systemic Asset**: Digital work created and structured to benefit an entire collective institution permanently. (시스템적 자산 (조직 공유 영속 자산))
...
Slide 38 returns to our spiritual compass: "Redeeming the Time."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Soli Deo Gloria: 시간 구속과 인지적 자유 (에베소서 5:16)
- **핵심 포인트:**
...
- **강의 전달 팁:** 목회자적 따뜻함으로 시간 구속의 영적 의미를 깊이 있게 전달하세요.

### 📚 Key Terms (주요 용어)
- **Cognitive Freedom**: The mental clarity achieved by eliminating repetitive administrative search friction. (인지적 자유 (행정 마찰 제거를 통한 정신적 여유))
...
Slide 39 brings us to our closing summit: "Soli Deo Gloria: Committing Our Work to Eternal Purpose."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Soli Deo Gloria: 영원한 목적을 향한 일상의 헌신
- **핵심 포인트:**
...
- **강의 전달 팁:** 경건하고 확신에 찬 어조로 강의의 본질적 가치를 마음속에 새겨주세요.

### 📚 Key Terms (주요 용어)
- **Soli Deo Gloria**: Glory to God Alone: The guiding theological foundation of all purposeful IT architecture. (Soli Deo Gloria (오직 하나님께 영광))

---

## Slide 40: LAB 5 ASSIGNMENT: GAS-POWERED SHARED VAULT
**Subtitle:** Architect, govern, and automate an enterprise Google Shared Drive system (Due Week 6)

### 🎙️ English Lecture Script

We have reached the conclusion of Session 5! Look at Slide 40 for your Lab 5 Homework Assignment.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Lab 5 실습 과제 안내: GAS 기반 자동화 공유 드라이브 금고 구축
- **핵심 포인트:**
...
- **강의 전달 팁:** 학생들이 팀을 이루어 실무적인 공유 금고를 완성할 수 있도록 격려하며 수업을 마칩니다.

### 📚 Key Terms (주요 용어)
- **GAS-Powered Shared Vault**: An automated Google Shared Drive architecture integrating role security, naming SOP, and Apps Script logging. (GAS 기반 자동화 공유 금고 (Lab 5 과제))
