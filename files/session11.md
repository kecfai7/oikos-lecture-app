...
- [Slide 11: PART 2: HEUREKABENCH & THINK-ACT-OBSERVE](#slide-11-part-2-heurekabench-think-act-observe)
...
- [Slide 21: PART 3: FACT VERIFICATION & GOVERNANCE](#slide-21-part-3-fact-verification-governance)
...
- [Slide 29: SPECULATIVE SECURITY & POISON PROMPT DEFENSES](#slide-29-speculative-security-poison-prompt-defenses)
- [Slide 30: SYSTEMIC ALIGNMENT: ANCHORING TO TRUTH](#slide-30-systemic-alignment-anchoring-to-truth)
- [Slide 31: PART 4: CO-EVOLUTION & ACTIVE STEWARDSHIP](#slide-31-part-4-co-evolution-active-stewardship)
...
- [Slide 37: ENTERPRISE SCALING & ACADEMIC COMPLIANCE](#slide-37-enterprise-scaling-academic-compliance)
- [Slide 38: HANDS-ON LAB 11: THE LITERATURE SYNTHESIZER](#slide-38-hands-on-lab-11-the-literature-synthesizer)
- [Slide 39: LAB 11 EVALUATION RUBRIC & SUCCESS METRICS](#slide-39-lab-11-evaluation-rubric-success-metrics)
- [Slide 40: COURSE SUMMARY: RECLAIMING TRUTH & TIME](#slide-40-course-summary-reclaiming-truth-time)
...
Good evening, esteemed scholars and future architects of Oikos University! Welcome back to Session 11 of our master course: "The Architect of Intelligence: Mastering Agentic IT and Strategic Wisdom." My name is Professor Peter Kim.
...
- **강의 전달 팁:** 과학적 진리 탐구의 숭고함과 학문적 엄밀성을 품격 있는 어조로 선포하며 시작하세요.
...
Look at Slide 3: "The Academic Sabbath: Reclaiming Bandwidth."
...
- **강의 전달 팁:** 논문 쓰느라 밤새 서지 정보와 씨름하던 수강생들의 고통을 공감하며 해방의 비전을 제시하세요.
...
Please look at Slide 4: "Smart Insight Lab: The Pursuit of Veracity."
...
- **강의 전달 팁:** 데이터 소비자가 아닌, 데이터를 통솔하는 지적 아키텍트의 위상을 재확인하세요.
...
Look at Slide 5 for our core technical challenge: "The Crisis of the Lying Parrot."
...
- **강의 전달 팁:** AI의 유창함에 속지 말고 출처와 코드로 뒷받침되는 진실성 검증의 중요성을 역설하세요.
...
Slide 6 charts the evolution: "The Birth of the AI Co-Scientist."
...
- **강의 전달 팁:** 지칠 줄 모르는 천재 박사과정 연구원을 연구실에 영입하는 이미지로 설명하세요.
...
Look at Slide 7: "The High Price of False Assertions."
...
- **강의 전달 팁:** 학자로서의 진실성과 데이터의 무결성에 대한 엄격한 프로페셔널 정신을 강조하세요.
...
- **강의 전달 팁:** 학생들이 연구 현장에서 겪었던 가장 큰 고충을 스스로 짚어보도록 유도하세요.
...
Look at the poll analysis on Slide 9: "Overcoming the Manual Grind."
...
- **강의 전달 팁:** 12시간의 피로한 독서를 10분의 고속 병렬 분석으로 단축하는 기적을 설명하세요.
...
Slide 10 presents our comprehensive roadmap for today:
...
- **강의 전달 팁:** 전체 강의의 4대 기둥을 시원하게 조망하며 다음 파트로 이끌어 주세요.
...
We now enter Part 2: "HeurekaBench and the THINK-ACT-OBSERVE Engine."
...
- **강의 전달 팁:** 기계가 스스로 가설을 세우고 실험을 돌리는 진정한 과학 엔진의 내부로 청중을 안내하세요.
...
Look at Slide 12: "What is HeurekaBench?"
...
- **강의 전달 팁:** 기출문제 암기가 아닌, 난생처음 보는 문제를 스스로 풀어내는 진짜 실력 검증임을 강조하세요.
...
Slide 13 highlights "Deducing Unseen Scientific Literature."
...
- **강의 전달 팁:** 뉴턴의 책을 읊는 학생과 새로운 실험실에서 가설을 입증하는 연구원의 차이를 들어 설명하세요.
...
Look at Slide 14: "Assessing the 'Heureka!' Moment."
...
- **강의 전달 팁:** 목욕탕에서 부력의 원리를 깨달은 아르키메데스처럼 AI가 진리를 발견하는 과정을 생생히 묘사하세요.
...
Slide 15 reveals our core engine: "The Perpetual THINK-ACT-OBSERVE Engine."
...
- **강의 전달 팁:** 가설 세우고, 실험하고, 결과 관찰하는 과학자들의 전통적 연구 방식을 AI가 완벽히 재현함을 설명하세요.
...
Look at Slide 16 for a deep dive into "The THINK Phase."
...
- **강의 전달 팁:** 수석 연구 책임자(PI)로서 실험 설계도를 완벽하게 그리는 두뇌의 역할을 강조하세요.
...
Slide 17 explores "The ACT Phase."
...
- **강의 전달 팁:** 설계도를 들고 실험실에서 직접 시약을 섞고 기계를 돌리는 실행 요원의 모습을 묘사하세요.
...
Look at Slide 18 for "The OBSERVE Phase."
...
- **강의 전달 팁:** 실험 결과를 현미경으로 들여다보며 오차를 측정하는 꼼꼼한 감리관의 역할을 설명하세요.
...
Slide 19 illustrates "The Recursive Error Correction Loop."
...
- **강의 전달 팁:** 오류 앞에서 멈추지 않고 스스로 디버깅하며 답을 찾아가는 AI의 끈기를 전하세요.
...
Look at Slide 20 for an astonishing real-world case study: "The Single-Cell Genomic Journey."
...
- **강의 전달 팁:** 14분 만에 수개월 치 연구를 끝내버리는 바이오 AI 혁신의 엄청난 파괴력을 전달하세요.
...
We now enter Part 3: "Fact Verification & Governance."
...
- **강의 전달 팁:** 과학적 결론의 신뢰성을 보증하는 수학적·암호학적 방어막을 소개하세요.
...
Slide 22 details our first line of defense: "Grounded RAG."
...
- **강의 전달 팁:** 오염되지 않은 깨끗한 샘물(검증된 논문)만 마시게 하여 거짓말을 원천 차단하는 원리를 설명하세요.
...
Look at Slide 23 for our core audit technique: "Atomic Fact Verification."
...
- **강의 전달 팁:** 진실 속에 교묘히 숨어든 거짓을 찾아내기 위해 문장을 원자 단위로 쪼개는 현미경 검증을 설명하세요.
...
Slide 24 reveals "The 'Honest Mirror' Mechanism."
...
- **강의 전달 팁:** 신호등 색상으로 모든 문장이 명백하게 필터링되는 직관적인 거울의 원리를 전하세요.
...
Look at Slide 25: "The Critic Module: The Wise Mentor."
...
- **강의 전달 팁:** 학생의 초안을 엄격하게 감수하여 완성도를 끌어올리는 대학원 지도교수의 비유를 드세요.
...
Slide 26 presents our cryptographic anchor: "The Code Execution Receipt."
...
- **강의 전달 팁:** 누구도 위조할 수 없는 디지털 공증 영수증을 모든 계산마다 발행하는 철저함을 설명하세요.
...
Look at Slide 27: "Translating Complex Logic: Code to English."
...
- **강의 전달 팁:** 복잡한 기계의 언어를 명쾌한 인간의 언어로 통역해 주는 훌륭한 번역 계층을 소개하세요.
...
Slide 28 presents our final evaluator: "The Impartial Judge: The LLM Grader Pipeline."
...
- **강의 전달 팁:** 사리사욕이나 편견 없이 오직 증거와 논리로만 논문을 채점하는 엄정한 판관의 모습을 설명하세요.
...
Look at Slide 29: "Speculative Security & Poison Prompt Defenses."
...
- **강의 전달 팁:** 악의적인 논문이 AI의 두뇌를 조종하려 할 때 이를 무력화하는 데이터 격리 방화벽을 설명하세요.
...
Slide 30 summarizes Section 3: "Systemic Alignment: Anchoring to Truth."
...
- **강의 전달 팁:** 타협할 수 없는 3가지 진리 수호 원칙을 단호하고 신뢰감 있게 선포하세요.
...
We now open Part 4: "Human-AI Co-Evolution and Active Stewardship."
...
- **강의 전달 팁:** 인간의 영적·윤리적 주권을 재확인하며 감동적인 학문적 피날레로 이끌어 주세요.
...
Look at Slide 32: "The Symphony of Scientific Discovery: Heart versus Brain."
...
- **강의 전달 팁:** 따뜻한 인간성과 차가운 연산력의 완벽한 조화를 감동적으로 묘사하세요.
...
Slide 33 reinforces your role: "The Conductor: Human-on-the-Loop Governance."
...
- **강의 전달 팁:** 지휘봉을 들고 있는 인간의 절대적 통솔권과 거버넌스 책임을 강조하세요.
...
Look at Slide 34 for a solemn warning: "The Danger of Intellectual Sloth."
...
- **강의 전달 팁:** 편리함에 속아 생각하기를 멈추는 지적 게으름을 엄히 경고하고 지적 단련을 주문하세요.
...
Slide 35 brings us back to our spiritual foundation: "Redeeming the Time."
...
- **강의 전달 팁:** 기술이 가져다주는 최고의 축복은 바로 '생명의 시간 회복'임을 가슴 벅차게 전하세요.
...
Look at Slide 36: "Eco-Friendly Computing with TPU v8."
...
- **강의 전달 팁:** 고성능 AI 컴퓨팅과 환경 보호를 동시에 달성하는 지속 가능한 기술 철학을 전달하세요.
...
Slide 37 outlines "Enterprise Scaling & Academic Compliance."
...
- **강의 전달 팁:** 병원이나 기업 연구소에서 안심하고 도입할 수 있는 철저한 컴플라이언스 기준을 제시하세요.
...
Look at Slide 38 for your Hands-on Lab 11 Assignment: "Building the Literature Synthesizer."
...
- **강의 전달 팁:** 학생들이 직접 완벽한 팩트체크 시스템을 코딩해보는 실습 절차를 명쾌히 안내하세요.
...
Slide 39 presents our strict Lab 11 Evaluation Rubric:
...
- **강의 전달 팁:** 명확한 3대 평가 기준을 제시하여 학생들이 완벽한 무결점 과제를 완성하도록 격려하세요.
...
That brings us to the conclusion of Session 11! Look at Slide 40 for our next summit.
...
- **강의 전달 팁:** 학생들을 축복하며 다음 주 12강 월드 모델 강의에 대한 기대감을 높이며 마무리하세요.
