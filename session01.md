...
- [Slide 02: COURSE PHILOSOPHY](#slide-02-course-philosophy)
...
- [Slide 11: METAPHOR: THE APPLE STORY](#slide-11-metaphor-the-apple-story)
...
- [Slide 21: MASSIVE INFORMATION SCALE](#slide-21-massive-information-scale)
...
- [Slide 31: HNP TRANSACTIONS](#slide-31-hnp-transactions)
...
Welcome everyone! My name is Professor Peter Kim, and it is a great pleasure to welcome you to Oikos University. Today, we begin our exciting course: "The Architect of Intelligence."
...
- **강의 요약:** 강의 전체 개요 및 Oikos University 인공지능 지능 건축가(Architect) 과정 환영 인사
- **핵심 포인트:**
...
- **강의 전달 팁:** 밝고 당당한 어조로 강의를 시작하세요. 'Architect'라는 단어의 중요성을 강조하며 학생들의 기대감을 높여줍니다.

### 📚 Key Terms (주요 용어)
- **Architect**: A master planner who designs and directs big systems. (건축가 / 시스템 통합 설계자)
- **Agentic IT**: AI systems that can take independent actions to achieve goals. (에이전틱 IT (자율 행동형 인공지능))

---

## Slide 02: COURSE PHILOSOPHY
**Subtitle:** Orchestrate, do not consume: Elevate your role from writer to systems director

### 🎙️ English Lecture Script

Let us examine our course philosophy on Slide 2. Please look at the comparison on the screen between Yesterday and Today.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 전통적 프로그래머와 현대 인공지능 건축가(Intelligence Architect)의 패러다임 비교
- **핵심 포인트:**
...
- **강의 전달 팁:** 좌우 카드를 대조하며 설명하세요. 'Orchestrate'라는 단어를 오케스트라 지휘자 동작 모션과 함께 전달하면 효과적입니다.

### 📚 Key Terms (주요 용어)
- **Orchestrate**: To lead or direct multiple components working together smoothly. (지휘하다 / 통합 조율하다)
- **Syntax Error**: A mistake in the spelling or grammar of computer code. (구문 에러 (코드 문법 오류))
...
At Oikos University, our core motto is "Soli Deo Gloria"—Glory to God Alone. What does this Latin motto mean for an advanced IT course?
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Oikos University의 핵심 교육 가치관 및 Soli Deo Gloria의 IT적 승화
- **핵심 포인트:**
...
- **강의 전달 팁:** 단순한 기술 강의를 넘어 진정한 지혜(Wisdom)와 가치관을 전달하는 진중하고 따뜻한 톤을 유지하세요.

### 📚 Key Terms (주요 용어)
- **Mandate**: An important duty or assignment given to us. (사명 / 숭고한 임무)
- **Automate**: To make a process run automatically without manual effort. (자동화하다)
...
In my research at Smart Insight Lab, we structure our work around three essential pillars.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Smart Insight Lab의 3대 핵심 기둥 (데이터, 기술, 라이프 OS)
- **핵심 포인트:**
...
- **강의 전달 팁:** 3가지 카드를 각각 지목하면서 인공지능 기술과 삶의 균형(Life OS)을 강조해 주세요.

### 📚 Key Terms (주요 용어)
- **Signal vs Noise**: Signal is valuable truth; noise is meaningless distraction. (신호 대 잡음 (유의미한 정보 대 가짜/잡음 정보))
- **Life OS**: A personal operating framework for managing health, focus, and habits. (라이프 OS (개인 삶의 운영 체계))
...
I want to share a short personal story with you on Slide 5.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 어린 시절의 분신 로봇 꿈과 2026년 자율 인공지능 아바타(Digital Twin)의 현실화
- **핵심 포인트:**
...
- **강의 전달 팁:** 자연스러운 미소와 함께 스토리텔링 방식으로 전달하세요. 학생들의 호기심과 친근감을 이끌어냅니다.

### 📚 Key Terms (주요 용어)
- **Autonomous**: Operating independently without constant human clicking. (자율적인 / 스스로 판단하여 작동하는)
- **Digital Twin**: A virtual software representation that acts on your behalf. (디지털 트윈 (가상 분신 에이전트))
...
Let us discuss the most valuable currency in human life on Slide 6.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 시간의 가치와 에이전트 도입을 통해 되찾는 매일 3~4시간의 'Agentic Dividend'
- **핵심 포인트:**
...
- **강의 전달 팁:** '3-4 HOURS'라는 메트릭 숫자를 강조하며 손가락으로 3을 펼치는 동작을 해주시면 시각적 효과가 뛰어납니다.

### 📚 Key Terms (주요 용어)
- **Agentic Dividend**: The bonus free time gained by delegating work to AI agents. (에이전트 배당금 (에이전트 위임으로 되찾은 시간적 이득))
- **Delegation**: Entrusting tasks to a trusted assistant or system. (위임 (권한과 작업을 맡김))
...
On Slide 7, here are our three main learning objectives for today's 60-minute session.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 오늘 60분 수업에서 마스터할 3대 핵심 학습 목표
- **핵심 포인트:**
...
- **강의 전달 팁:** 목표를 하나씩 명확하게 읽어주어 학생들이 오늘 강의의 로드맵을 머릿속에 그릴 수 있도록 돕습니다.

### 📚 Key Terms (주요 용어)
- **Paradigm Shift**: A fundamental change in approach or underlying assumptions. (패러다임 전환 (대대적인 인식/방식의 변화))
- **Governance**: Rules, parameters, and security bounds enforced on a system. (거버넌스 (통제 및 보안 규칙))
...
Please look at Slide 9, where we analyze "Yesterday: Reactive Chatbots."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 기존 수동적(Reactive) 챗봇의 3가지 명확한 한계점 분석
- **핵심 포인트:**
...
- **강의 전달 팁:** 'All talk and no action!'이라는 문장을 유머러스하고 위트 있게 전달해보세요.

### 📚 Key Terms (주요 용어)
- **Reactive**: Only acting in response to a direct manual command. (반응형 / 수동적인)
- **Interface Trap**: Being locked into sitting in front of a screen to press buttons. (인터페이스 트랩 (화면 종속성 문제))
...
Now, let us contrast yesterday's chatbots with Slide 10: "Today: Proactive Avatars!"
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 오늘날 24/7 클라우드 기반 능동형 자율 아바타(Proactive Avatars)의 이점
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Digital Freedom'이라는 단어를 힘주어 말하며 24시간 클라우드 에이전트의 편리함을 강조합니다.

### 📚 Key Terms (주요 용어)
- **Proactive**: Taking action automatically before being asked. (주도적인 / 능동적인)
- **Persistence**: Continuing to run in the background without stopping. (지속성 / 영속성)

---

## Slide 11: METAPHOR: THE APPLE STORY
**Subtitle:** The fundamental difference between talking and acting

### 🎙️ English Lecture Script

To make this paradigm shift crystal clear, let us examine Slide 11: "Metaphor: The Apple Story."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 사과 주문 비유를 통한 챗봇과 에이전트의 결정적 차이 해설
- **핵심 포인트:**
...
- **강의 전달 팁:** 비유가 직관적이고 재미있으므로 보이스 톤에 변화를 주어 생동감 있게 전달하세요.

### 📚 Key Terms (주요 용어)
- **Metaphor**: A picture or story used to explain a complex idea easily. (비유 / 은유)
- **Transaction**: Executing a real-world exchange or business action. (트랜잭션 (거래 및 실질적 과업 실행))
...
Here is another fun comparison on Slide 12: "Video Game Computing."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 비디오 게임 비유: 반복 노가다(Grinding) vs 오프라인 자동 레벨업(Offline Leveling)
- **핵심 포인트:**
...
- **강의 전달 팁:** 게임을 해본 학생들의 웃음과 반응을 유도하기 좋은 슬라이드입니다.

### 📚 Key Terms (주요 용어)
- **Manual Grinding**: Repetitive, tiring manual effort required for small progress. (반복적인 노가다 작업)
- **Offline Leveling**: Automated background progress happening while user is offline. (오프라인 자동 레벨업 / 백그라운드 성장)
...
Please turn your attention to Slide 13: "Scaling Human Attention."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 인간 직렬 처리 능력의 한계와 클라우드 병렬 처리(3,200조 노드)의 결합
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Linear vs Parallel'의 구성을 손동작으로 대비시켜 설명해 주세요.

### 📚 Key Terms (주요 용어)
- **Linear Focus**: Processing one single task step-by-step sequentially. (직렬 집중 (단일 업무 순차 처리))
- **Parallel Processing**: Handling thousands of independent data streams at the exact same instant. (병렬 처리 (다중 동시 실행))
...
Now, let us do a quick interactive exercise on Slide 14!
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실시간 수강생 설문조사: 매일 되찾은 3시간을 어디에 사용할 것인가?
- **핵심 포인트:**
  - Option A: 학업 깊이 수련 및 독서 (35%)
  - Option B: 예체능 및 신체 수련 (20%)
  - Option C: 휴식, 가족과의 시간, 영적 성장 (30%)
  - Option D: 신규 에이전트 창업 및 비즈니스 (15%)
- **강의 전달 팁:** 수강생들이 실제로 화면을 클릭하거나 투표할 수 있도록 10초 정도 여유 시간을 주고 참여를 유도합니다.

### 📚 Key Terms (주요 용어)
- **Interactive Poll**: A live voting feature to gather audience sentiment in real time. (실시간 상호작용 투표)
...
Thank you all for voting! Look at the live results summarized on Slide 15.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 투표 결과 분석 및 인사이트: 자동화의 진정한 목적은 인간다운 삶의 회복
- **핵심 포인트:**
...
- **강의 전달 팁:** 가장 진정성 있고 감동적인 톤으로 메시지를 전달하여 Oikos Univ의 진정한 교육 미션을 상기시킵니다.

### 📚 Key Terms (주요 용어)
- **Human Flourishing**: The holistic well-being and growth of human mind, body, and spirit. (인간다운 삶의 번영과 성장)
...
We have now completed our foundational section on human philosophy and time reclamation.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 철학적 논의에서 클라우드 시스템 엔지니어링 섹션으로의 전환 브릿지
- **핵심 포인트:**
...
- **강의 전달 팁:** 이제 본격적인 IT 기술 및 엔지니어링 내용이 나온다는 흥미를 유발하세요.

### 📚 Key Terms (주요 용어)
- **Bridge**: A connecting concept that links philosophy to practical engineering. (연결 다리 / 가교)
...
Slide 18 explains one of the most important concepts in computer science: "Synchronous vs. Asynchronous."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 컴퓨터 공학 핵심 개념: 동기식(Synchronous) vs 비동기식(Asynchronous) 비교
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Non-blocking'이라는 단어를 강조하면서 노트북 덮개를 닫는 흉내를 내어 명확히 각인시킵니다.

### 📚 Key Terms (주요 용어)
- **Synchronous (Blocking)**: Forcing the program and user to wait until a task completes. (동기식 (대기 블로킹 방식))
- **Asynchronous (Non-Blocking)**: Allowing background tasks to run independently while user continues other work. (비동기식 (논블로킹 백그라운드 방식))
...
Slide 19 introduces the brain powering our agent swarm: "The Gemini 3.5 Flash Engine."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 조율을 위해 최적화된 Gemini 3.5 Flash 추론 엔진의 4배 빠른 속도
- **핵심 포인트:**
...
- **강의 전달 팁:** 에이전트에게는 단순 거대 모델보다 '빠른 판단 속도(Latency)'가 핵심임을 설명하세요.

### 📚 Key Terms (주요 용어)
- **Inference Speed**: The rate at which an AI model processes inputs and generates decisions. (추론 속도)
- **Tool Routing**: The ability of an AI to select and call external APIs accurately. (툴 라우팅 (적절한 도구 선택 및 실행))
...
Look at the hardware chart on Slide 20: "Hardware Infrastructure: TPU v8."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 TPU v8 칩셋 인프라를 통한 친환경/고성능 클라우드 연산 지원
- **핵심 포인트:**
  - TPU v8: AI 연산 전용 특화 칩으로 이전 세대 대비 3배 성능 향상
  - 에너지 효율성: 토큰당 전력 소비량을 60% 이상 절감하여 친환경 구현
  - 지속 가능성: 24시간 작동 인프라의 연산 비용 및 환경적 영향 최소화
- **강의 전달 팁:** 그래프의 상승 곡선을 가리키며 고성능과 친환경(Sustainable)의 조화를 강조하세요.

### 📚 Key Terms (주요 용어)
- **TPU (Tensor Processing Unit)**: Custom-designed AI hardware chip created for high-speed tensor math. (TPU (구글 AI 전용 가속 칩))
- **Sustainable Computing**: Designing hardware to minimize carbon footprint and power usage. (지속 가능한 친환경 연산)

---

## Slide 21: MASSIVE INFORMATION SCALE
**Subtitle:** Connecting real-time web, email, and personal documents

### 🎙️ English Lecture Script

Slide 21 shows the massive scale of knowledge processing: "3.2 Billion Tokens of Context Synthesis."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 32억 토큰 규모의 실시간 문맥 종합(Context Synthesis) 및 정보 연결 능력
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Connecting the dots' (점들을 연결한다) 모션을 사용하여 정보 합성 능력을 설명하세요.

### 📚 Key Terms (주요 용어)
- **Context Synthesis**: Merging multi-source data streams into a unified understanding. (문맥 종합 및 정보 합성)
...
Please pay close attention to Slide 22! This is "The Triad of Agentic Design"—the core golden rule of our course.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 설계 3대 황금 공식: 과업(Task), 일정(Schedule), 스킬(Skill)
- **핵심 포인트:**
...
- **강의 전달 팁:** 손가락 3개를 펼치며 TASK, SCHEDULE, SKILL을 하나씩 명확히 짚어주세요.

### 📚 Key Terms (주요 용어)
- **Task-Schedule-Skill Triad**: The foundational 3-part blueprint for defining autonomous AI agents. (에이전트 설계 3요소 (과업-일정-스킬 삼각주))
...
Let us look at Slide 23 to see how your agent stores its files in Google Drive: "Spark OS Directory Setup."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글 드라이브 내 Spark OS 루트 디렉토리 구조 및 3대 서브 폴더 역할
- **핵심 포인트:**
...
- **강의 전달 팁:** 실제 구글 드라이브 화면을 연상시키도록 트리 구조를 말로 차분히 따라가며 설명하세요.

### 📚 Key Terms (주요 용어)
- **Directory Tree**: A hierarchical folder structure used to organize computer files. (디렉토리 트리 (폴더 계층 구조))
...
Slide 24 details the "Dual Memory Engine" inside Gemini Spark.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 기억상실증 방지를 위한 이중 메모리 엔진 (단기 작업 메모리 vs 장기 지속 메모리)
- **핵심 포인트:**
...
- **강의 전달 팁:** 'AI 기억상실증(Amnesia)'이라는 단어를 예로 들며 장기 메모리의 중요성을 어필하세요.

### 📚 Key Terms (주요 용어)
- **Persistent Memory**: Memory that remains saved on disk across computer reboots and sessions. (영속 메모리 (지속성 장기 기억))
...
On Slide 25, we look at "Google Workspace Native Integration."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 복잡한 API 키 입력 없는 구글 워크스페이스(Gmail, Docs, Sheets, Drive) 네이티브 연동
- **핵심 포인트:**
...
- **강의 전달 팁:** 메일 수신부터 드라이브 저장까지 손으로 화살표를 그리듯 순서대로 설명해 보세요.

### 📚 Key Terms (주요 용어)
- **Native Integration**: Direct built-in software connections requiring no external middleman software. (네이티브 연동 (내장 통합))
...
Let us examine a real-world enterprise enterprise case study on Slide 26: "Virgin Voyages Cruise Line."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 실제 기업 사례 연구: 버진 보이지스(Virgin Voyages) 크루즈 예약 처리 시간 혁신
- **핵심 포인트:**
...
- **강의 전달 팁:** '6시간에서 11분으로!' 이 극적인 숫자의 대비를 힘있게 호목하여 수강생들에게 강한 인상을 남깁니다.

### 📚 Key Terms (주요 용어)
- **Case Study**: A real-world business scenario analyzed to prove technical results. (사례 연구 (기업 성공 데이터))
...
Slide 28 highlights the dangerous nightmare of giving an AI agent unrestricted access to money: "Financial Risk: Uncontrolled Wallet."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 신용카드 직접 연결의 무서운 위험성과 프로토콜 자금 잠금의 필요성
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Imagine your credit card draining in 10 seconds!'라는 과장되지 않은 경고로 집중도를 높입니다.

### 📚 Key Terms (주요 용어)
- **Runaway Loop**: A software bug where code repeats uncontrollably, wasting resources or money. (폭주 루프 (무한 결제/호출 오류))
...
To solve this financial danger, Google created AP2, featured on Slide 29: "Agent Payments Protocol."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 구글의 에이전트 전용 안전 결제 프로토콜 AP2(Agent Payments Protocol) 3대 작동 원리
- **핵심 포인트:**
...
- **강의 전달 팁:** 카드 번호 노출 없이 토큰으로 안전하게 결제된다는 점을 명확히 전달하세요.

### 📚 Key Terms (주요 용어)
- **AP2 Protocol**: Agent Payments Protocol—Google's secure commerce standard for AI agents. (AP2 프로토콜 (에이전트 결제 보안 규격))
- **Tokenization**: Replacing sensitive card data with random encrypted placeholder keys. (토큰화 (보안 암호 키 대체))
...
On Slide 30, we see the structure of "The Digital Mandate"—an unalterable safety contract for spending.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 자금 지출을 통제하는 디지털 위임장(Digital Mandate) 3대 필수 계약 규칙
- **핵심 포인트:**
...
- **강의 전달 팁:** 손가락으로 1, 2, 3을 세어가며 계약 규칙의 엄격함을 강조합니다.

### 📚 Key Terms (주요 용어)
- **Digital Mandate**: A signed digital permission slip detailing maximum budget, vendor limits, and time bounds. (디지털 위임장 (지출 권한 부여 및 한도 계약서))

---

## Slide 31: HNP TRANSACTIONS
**Subtitle:** High-speed machine commerce while you sleep

### 🎙️ English Lecture Script

Slide 31 introduces a key term in autonomous commerce: "HNP Transactions."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 사람이 자고 있는 동안 이루어지는 자율 거래 HNP(Human Not Present)와 0.1초 검증
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Human Not Present'라는 개념을 조용하지만 강력하게 강조하여 자율 Commerce 시대를 실감하게 합니다.

### 📚 Key Terms (주요 용어)
- **HNP (Human Not Present)**: Transactions completed automatically by software without real-time human clicking. (HNP (인간 부재 자율 거래))
...
Please pay close attention to Slide 32: "Security Threat: Prompt Injection."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 인공지능 에이전트 최고의 보안 위협 '프롬프트 인젝션(Prompt Injection)'과 격리 방어선
- **핵심 포인트:**
...
- **강의 전달 팁:** 해커의 공격 수법(백색 텍스트 프롬프트 인젝션)을 흥미롭게 설명하여 경각심을 끌어올립니다.

### 📚 Key Terms (주요 용어)
- **Prompt Injection**: A security attack where untrusted input text tricks an AI into breaking safety rules. (프롬프트 인젝션 (악의적 프롬프트 주입 공격))
...
Slide 33 answers the core question: How do we trust our cloud agents? Answer: "Cryptographic Audit Trails."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트의 모든 판단과 행동을 암호화하여 기록하는 Cryptographic Audit Trail
- **핵심 포인트:**
...
- **강의 전달 팁:** 'Verification, not guessing!' 문장을 유쾌하고 명확하게 소리 내어 전달해 보세요.

### 📚 Key Terms (주요 용어)
- **Audit Trail**: A step-by-step chronological record providing proof of system activities. (감사 로그 / 추적 기록 (Audit Trail))
...
On Slide 34, we analyze an enterprise corporate management paradox: "Shadow IT vs. Enterprise Compliance."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 무조건적 AI 차단이 부르는 'Shadow IT' 위험성과 공식 컴플라이언스 채널 구축
- **핵심 포인트:**
...
- **강의 전달 팁:** 기업 IT 관리자나 직장인 수강생들이 크게 공감할 수 있는 실무적 토픽입니다.

### 📚 Key Terms (주요 용어)
- **Shadow IT**: Using unapproved personal devices or software for corporate work without IT department knowledge. (섀도우 IT (미승인 개인 IT 도구 사용 위험))
...
Slide 35 presents the strategic governance spectrum: "Balancing Autonomy and Control."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 자율성(Autonomy)과 통제성(Control) 사이의 최적 적응형 거버넌스(Adaptive Governance) 설계
- **핵심 포인트:**
...
- **강의 전달 팁:** 양극단의 트레이드오프(Trade-off)를 짚어주고 적응형 거버넌스를 해법으로 제시합니다.

### 📚 Key Terms (주요 용어)
- **Adaptive Governance**: Dynamically adjusting permission requirements based on task risk level. (적응형 거버넌스 (위험도별 차등 통제))
...
On Slide 36, we summarize our security architecture into "Defense in Depth for Agents."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 에이전트 보호를 위한 3중 방어 체계 (Defense in Depth)
- **핵심 포인트:**
...
- **강의 전달 팁:** 3가지 레이어를 쉴드(Shield) 모양으로 묘사하며 든든한 보안의 중요성을 어필합니다.

### 📚 Key Terms (주요 용어)
- **Defense in Depth**: A security strategy employing multiple redundant defensive layers. (심층 방어 (3중 안전 보안 체계))
...
Slide 38 illustrates our core operational paradigm: "Human-on-the-Loop (HOTL)."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** Human-on-the-Loop (HOTL) 모델: 인간은 지휘자, AI 에이전트는 오케스트라 단원
- **핵심 포인트:**
...
- **강의 전달 팁:** 오케스트라 지휘자를 묘사하는 큰 손동작을 사용하여 감동적으로 전달해 주세요.

### 📚 Key Terms (주요 용어)
- **Human-on-the-Loop (HOTL)**: An architecture where AI executes tasks independently while a human supervisor holds authority over direction and rules. (Human-on-the-Loop (인간 감독관 조율 모델))
...
Look at Slide 39 as we reflect on our personal lives: "Reclaiming Offline Focus."
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 스마트폰 화면 중독에서 벗어나 오프라인 몰입과 삶의 평안을 되찾기
- **핵심 포인트:**
...
- **강의 전달 팁:** 스마트폰을 주머니에 넣는 모션을 취하며 'Put your phone away'를 묵직하게 전달합니다.

### 📚 Key Terms (주요 용어)
- **Mental Quietness**: A calm state of mind freed from digital noise and continuous smartphone alerts. (정신적 정적과 평안 (Digital Quietness))
...
We have reached the conclusion of Session 1! Please look at Slide 40 for your Hands-On Homework Assignment due next week.
...
### 🇰🇷 Korean Teaching Guide (강의 가이드)
- **강의 요약:** 1주차 과제(Hands-on Lab 1) 안내 및 강의 총결산 총평
- **핵심 포인트:**
...
- **강의 전달 팁:** 밝고 활기찬 목소리로 숙제를 명확히 안내하고 수강생들을 격려하며 수업을 마칩니다.

### 📚 Key Terms (주요 용어)
- **Specification Sheet**: A concise design document defining target requirements and boundaries. (명세서 (과제 기획안))
