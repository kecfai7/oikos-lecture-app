// Master Course Syllabus and 15-Session Curriculum Data (Global English Edition)
...
export const SESSIONS_CURRICULUM = [
  {
    ...
    parts: [
      {
        ...
        summary: "Transitioning from passive question-answering chatbots to proactive, goal-driven agents that execute multi-step real-world workflows without human waiting.",
        keyTopics: ["'Ask Me' vs. 'Run It For Me'", "Reclaiming Human Time", "Soli Deo Gloria Foundation"]
      },
      {
        partNum: 2,
      ...
      },
      {
        ...
        summary: "Connecting agents natively to Google Drive, Docs, Sheets, and Gmail via Google Apps Script (GAS) and persistent directory setups.",
    ...
    labMission: "Lab 1: Architect your first 24/7 personal assistant in Google Drive with persistent Spark OS directories."
  },
  {
    sessionNum: 2,
    ...
    parts: [
      ...
      },
      {
        ...
        summary: "Automating end-to-end business workflows across Gmail, Google Calendar, Google Docs, and Google Sheets without API latency.",
    ...
    labMission: "Lab 2: Construct an end-to-end Gemini Spark workflow that ingests inquiries, updates spreadsheets, and drafts replies."
  },
  {
    sessionNum: 3,
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      "Understand generational garbage collection, Site Isolation, and Spectre-level memory vulnerability defense.",
