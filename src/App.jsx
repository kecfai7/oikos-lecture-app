...
import { SLIDES_SESSION_1, SLIDES_SESSION_2, SLIDES_SESSION_3, SLIDES_SESSION_4, SLIDES_SESSION_5, SLIDES_SESSION_6, SLIDES_SESSION_7, SLIDES_SESSION_8, SLIDES_SESSION_9 } from './data/slidesData';
import { Keyboard } from 'lucide-react';

export default function App() {
  const [selectedSession, setSelectedSession] = useState(9);
  ...
  const currentSlides = 
    ...
    (SLIDES_SESSION_9 || SLIDES_SESSION_1);
